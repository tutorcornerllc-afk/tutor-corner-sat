...
const QUESTIONS = [
  ...
  { id: 51, domain: 'D4', difficulty: 'Easy', passage: 'The study found that exercise improves mood. _______, participants who worked out daily reported lower rates of anxiety.', question: 'Which transition best fits?', options: ['However', 'In contrast', 'Indeed', 'Although'], correct: 2, explanation: '"Indeed" reinforces the previous statement with supporting evidence.' },
  { id: 52, domain: 'D4', difficulty: 'Easy', passage: 'The new library opened last spring. _______, it quickly became the most visited public building in the city.', question: 'Which transition best fits?', options: ['Nevertheless', 'However', 'Since then', 'In contrast'], correct: 2, explanation: '"Since then" shows that events following the opening led to the outcome.' },
  { id: 53, domain: 'D4', difficulty: 'Medium', passage: 'Renewable energy is becoming cost-competitive with fossil fuels. _______, the transition to clean energy is still hampered by infrastructure challenges.', question: 'Which transition best fits?', options: ['Furthermore', 'Nevertheless', 'As a result', 'Similarly'], correct: 1, explanation: '"Nevertheless" concedes the cost improvement while introducing an obstacle.' },
  { id: 54, domain: 'D4', difficulty: 'Medium', passage: 'The report confirmed that screen time negatively affects sleep quality. _______, pediatricians are now recommending strict limits for children under twelve.', question: 'Which transition best fits?', options: ['However', 'In contrast', 'On the other hand', 'Accordingly'], correct: 3, explanation: '"Accordingly" shows the recommendation is a direct response to the findings.' },
  { id: 55, domain: 'D4', difficulty: 'Medium', passage: 'The coastal town had thrived on fishing for generations. _______, declining fish stocks have forced many families to abandon the trade entirely.', question: 'Which transition best fits?', options: ['As a result', 'Similarly', 'In recent years, however,', 'Furthermore'], correct: 2, explanation: '"In recent years, however," introduces a contrast with the town\'s historical prosperity.' },
  { id: 56, domain: 'D4', difficulty: 'Hard', passage: 'Early studies suggested the drug was safe. _______, a decade-long follow-up revealed serious cardiac side effects in a significant percentage of users.', question: 'Which transition best fits?', options: ['Furthermore', 'Similarly', 'Subsequently', 'In addition'], correct: 2, explanation: '"Subsequently" shows the follow-up happened after the early studies, introducing a contrasting result.' },
  { id: 57, domain: 'D4', difficulty: 'Hard', passage: 'The poet\'s early work was dismissed as derivative. _______, scholars now regard those same poems as foundational texts of the modernist movement.', question: 'Which transition best fits?', options: ['In addition', 'Paradoxically', 'As a result', 'Likewise'], correct: 1, explanation: '"Paradoxically" captures the contradiction between the early dismissal and later recognition.' },
  { id: 58, domain: 'D4', difficulty: 'Easy', passage: 'Inflation rose sharply in the third quarter. _______, consumer spending declined for the first time in two years.', question: 'Which transition best fits?', options: ['Nevertheless', 'Correspondingly', 'In contrast', 'Despite this'], correct: 1, explanation: '"Correspondingly" links the rise in inflation to the decline in spending as parallel effects.' },
  { id: 59, domain: 'D4', difficulty: 'Medium', passage: 'The medication proved effective in clinical trials. _______, its high cost has limited access for many patients who could benefit from it.', question: 'Which transition best fits?', options: ['Furthermore', 'Likewise', 'That said', 'As a result'], correct: 2, explanation: '"That said" acknowledges the effectiveness before introducing the access limitation.' },
  { id: 60, domain: 'D4', difficulty: 'Hard', passage: 'Automation is expected to displace millions of manufacturing jobs. _______, economists argue that technological revolutions have historically created more jobs than they destroy.', question: 'Which transition best fits?', options: ['As a result', 'Similarly', 'That said', 'Furthermore'], correct: 2, explanation: '"That said" introduces an important counterpoint to the negative prediction.' },
  { id: 61, domain: 'D4', difficulty: 'Easy', passage: 'The candidate had strong academic credentials. _______, her lack of work experience raised concerns among hiring managers.', question: 'Which transition best fits?', options: ['As a result', 'Furthermore', 'However', 'Similarly'], correct: 2, explanation: '"However" introduces a contrasting weakness after the strength.' },
  { id: 62, domain: 'D4', difficulty: 'Medium', passage: 'Urban green spaces reduce air pollution and lower temperatures. _______, they have been shown to improve mental health outcomes in city residents.', question: 'Which transition best fits?', options: ['However', 'In contrast', 'Moreover', 'Nevertheless'], correct: 2, explanation: '"Moreover" adds another benefit on top of the ones already mentioned.' },
  { id: 63, domain: 'D4', difficulty: 'Hard', passage: 'The algorithm performed flawlessly on training data. _______, it produced wildly inaccurate results when applied to real-world scenarios.', question: 'Which transition best fits?', options: ['In addition', 'Similarly', 'Furthermore', 'Yet'], correct: 3, explanation: '"Yet" strongly contrasts the training success with the real-world failure.' },
  { id: 64, domain: 'D4', difficulty: 'Easy', passage: 'Many students benefit from tutoring. _______, one-on-one instruction helps identify and address individual learning gaps.', question: 'Which transition best fits?', options: ['However', 'In contrast', 'Specifically', 'Nevertheless'], correct: 2, explanation: '"Specifically" introduces a precise reason why tutoring is beneficial.' },
  { id: 65, domain: 'D4', difficulty: 'Medium', passage: 'The river had flooded three times in the past decade. _______, city planners approved a major levee construction project.', question: 'Which transition best fits?', options: ['However', 'In response', 'Similarly', 'Furthermore'], correct: 1, explanation: '"In response" shows the construction was a direct reaction to the flooding.' },

  { id: 66, domain: 'D4', difficulty: 'Easy', passage: 'Regular exercise improves cardiovascular health. _______, it also boosts mental well-being significantly.', question: 'Which transition best fits?', options: ['However', 'In addition', 'Therefore', 'In contrast'], correct: 1, explanation: '"In addition" adds another benefit of exercise without contrasting.' },
  { id: 67, domain: 'D4', difficulty: 'Medium', passage: 'The author argues that social media increases loneliness. _______, several large-scale studies show no significant correlation between social media use and loneliness.', question: 'Which transition best fits?', options: ['Furthermore', 'As a result', 'Similarly', 'However'], correct: 3, explanation: '"However" introduces the contrasting evidence from studies.' },
  { id: 68, domain: 'D4', difficulty: 'Hard', passage: 'The vaccine was approved after rigorous clinical trials. _______, public hesitancy remains a significant barrier to achieving herd immunity.', question: 'Which transition best fits?', options: ['Similarly', 'Nonetheless', 'As a result', 'Consequently'], correct: 1, explanation: '"Nonetheless" concedes the approval while highlighting a persistent problem.' },
  { id: 69, domain: 'D4', difficulty: 'Medium', passage: 'The ancient ruins had been buried for centuries. _______, archaeologists uncovered them using ground-penetrating radar.', question: 'Which transition best fits?', options: ['Nevertheless', 'Consequently', 'Similarly', 'Eventually'], correct: 3, explanation: '"Eventually" shows that after effort over time, they were discovered.' },
  { id: 70, domain: 'D4', difficulty: 'Easy', passage: 'Eating breakfast improves focus and concentration. _______, students who eat breakfast perform better academically.', question: 'Which transition best fits?', options: ['However', 'In contrast', 'Not surprisingly', 'Despite this'], correct: 2, explanation: '"Not surprisingly" signals that the outcome logically follows from the benefit.' },
  { id: 71, domain: 'D4', difficulty: 'Hard', passage: 'Global temperatures have risen steadily since industrialization. _______, the rate of increase has accelerated dramatically in the past two decades.', question: 'Which transition best fits?', options: ['However', 'Moreover', 'In contrast', 'As a result'], correct: 1, explanation: '"Moreover" adds an intensifying detail -- the rate has not just continued but worsened.' },
  { id: 72, domain: 'D4', difficulty: 'Medium', passage: 'The documentary received mixed reviews from critics. _______, it became one of the highest-grossing documentaries of the decade.', question: 'Which transition best fits?', options: ['As a result', 'Similarly', 'Nevertheless', 'Furthermore'], correct: 2, explanation: '"Nevertheless" shows the commercial success despite the mixed reviews.' },

  { id: 73, domain: 'D4', difficulty: 'Hard', passage: 'The proposed tax reform would significantly reduce the deficit. _______, independent economists warn it could also slow economic growth by reducing consumer spending power.', question: 'Which transition best fits?', options: ['Similarly', 'That said', 'Furthermore', 'As a result'], correct: 1, explanation: '"That said" concedes the benefit while introducing the economic risk.' },
  { id: 74, domain: 'D4', difficulty: 'Hard', passage: 'Fossil fuel companies have long resisted carbon pricing. _______, several major oil producers have recently begun lobbying for a carbon tax, citing long-term market predictability.', question: 'Which transition best fits?', options: ['As a result', 'In addition', 'Paradoxically', 'Therefore'], correct: 2, explanation: '"Paradoxically" captures the irony of companies that resisted carbon taxes now supporting them.' },
  { id: 75, domain: 'D4', difficulty: 'Hard', passage: 'The author acknowledges that urban density increases carbon efficiency. _______, she insists that density alone cannot solve climate change without parallel changes in energy sources.', question: 'Which transition best fits?', options: ['Furthermore', 'In addition', 'Nevertheless', 'As a result'], correct: 2, explanation: '"Nevertheless" introduces the limitation despite the acknowledged benefit of density.' },
  { id: 76, domain: 'D4', difficulty: 'Hard', passage: 'The pharmaceutical company's breakthrough treatment showed 90% efficacy in trials. _______, regulatory approval will take at least three years, leaving patients without access in the interim.', question: 'Which transition best fits?', options: ['Similarly', 'Furthermore', 'Regrettably', 'As a result'], correct: 2, explanation: '"Regrettably" introduces the disappointing limitation after the promising result.' },
  { id: 77, domain: 'D4', difficulty: 'Hard', passage: 'Neural networks can identify patterns in data far beyond human capacity. _______, they remain unable to explain their reasoning -- a significant barrier to adoption in high-stakes fields like medicine and law.', question: 'Which transition best fits?', options: ['In addition', 'Consequently', 'And yet', 'Similarly'], correct: 2, explanation: '"And yet" strongly contrasts the capability with the critical limitation.' },
  { id: 78, domain: 'D4', difficulty: 'Hard', passage: 'Ancient Roman infrastructure -- roads, aqueducts, and sewers -- enabled the empire's expansion. _______, historians argue these same systems created dependencies that accelerated the empire's eventual collapse.', question: 'Which transition best fits?', options: ['Ironically', 'Furthermore', 'Therefore', 'In addition'], correct: 0, explanation: '"Ironically" captures the paradox: the systems enabling expansion also contributed to collapse.' },

  { id: 79, domain: 'D4', difficulty: 'Easy', passage: 'The athlete had trained for years. _______, she felt surprisingly calm before the championship race.', question: 'Which transition best fits?', options: ['As a result', 'Oddly enough', 'Since then', 'Furthermore'], correct: 1, explanation: '"Oddly enough" signals that the calm was unexpected given the pressure of years of training.' },
  { id: 80, domain: 'D4', difficulty: 'Medium', passage: 'Recent studies link ultra-processed food consumption to increased rates of depression. _______, mental health professionals are beginning to incorporate dietary advice into treatment plans.', question: 'Which transition best fits?', options: ['In contrast', 'Nevertheless', 'In response', 'Similarly'], correct: 2, explanation: '"In response" shows that the dietary advice is a direct reaction to the new research.' },
  { id: 81, domain: 'D4', difficulty: 'Medium', passage: 'The new subway line was projected to cost two billion dollars. _______, cost overruns and delays pushed the final price to nearly five billion.', question: 'Which transition best fits?', options: ['Similarly', 'Ultimately', 'In contrast', 'As planned'], correct: 1, explanation: '"Ultimately" shows what actually happened in the end, contrasting with the projection.' },
  { id: 82, domain: 'D4', difficulty: 'Hard', passage: 'The treaty was hailed as a diplomatic triumph. _______, within a decade, every signatory nation had withdrawn, and tensions had returned to pre-treaty levels.', question: 'Which transition best fits?', options: ['Similarly', 'Moreover', 'In hindsight', 'Therefore'], correct: 2, explanation: '"In hindsight" signals retrospective reassessment -- what looked like a triumph proved otherwise.' },
  { id: 83, domain: 'D4', difficulty: 'Hard', passage: 'Machine translation has improved dramatically in recent years. _______, professional translators argue that nuance, cultural context, and tone remain beyond the reach of current AI systems.', question: 'Which transition best fits?', options: ['As a result', 'Even so', 'Furthermore', 'Consequently'], correct: 1, explanation: '"Even so" concedes the improvement while maintaining the counterargument about limitations.' },
  { id: 84, domain: 'D4', difficulty: 'Easy', passage: 'Sleep deprivation affects memory consolidation. _______, students who pull all-nighters before exams often retain less information than those who sleep normally.', question: 'Which transition best fits?', options: ['However', 'In contrast', 'Not surprisingly', 'Nevertheless'], correct: 2, explanation: '"Not surprisingly" signals a predictable outcome that follows logically from the established fact.' },
  { id: 85, domain: 'D4', difficulty: 'Medium', passage: 'The species had been considered extinct for over a century. _______, a small colony was discovered thriving in a remote mountain region.', question: 'Which transition best fits?', options: ['As a result', 'Remarkably', 'Similarly', 'In addition'], correct: 1, explanation: '"Remarkably" signals an astonishing and unexpected discovery.' },
  { id: 86, domain: 'D4', difficulty: 'Hard', passage: 'Critics dismissed the painting as derivative. _______, when it sold at auction for forty million dollars, the art world was forced to reconsider its judgment.', question: 'Which transition best fits?', options: ['Therefore', 'Yet', 'Similarly', 'As predicted'], correct: 1, explanation: '"Yet" strongly contrasts the critical dismissal with the commercial validation.' },
  { id: 87, domain: 'D4', difficulty: 'Medium', passage: 'The company invested heavily in employee wellness programs. _______, productivity rose by 22 percent in the following year.', question: 'Which transition best fits?', options: ['However', 'Accordingly', 'In contrast', 'Nevertheless'], correct: 1, explanation: '"Accordingly" shows the productivity rise was a natural result of the wellness investment.' },
  { id: 88, domain: 'D4', difficulty: 'Hard', passage: 'Many economists predicted that the tariffs would reduce imports. _______, domestic producers were unable to scale up quickly enough to meet demand, causing shortages.', question: 'Which transition best fits?', options: ['Furthermore', 'As intended', 'However', 'Similarly'], correct: 1, explanation: '"As intended" acknowledges the tariffs worked as planned, before "causing shortages" reveals the unintended consequence.' },
  { id: 89, domain: 'D4', difficulty: 'Easy', passage: 'The hikers prepared extensively for the expedition. _______, they packed emergency supplies, studied weather patterns, and mapped alternate routes.', question: 'Which transition best fits?', options: ['However', 'Specifically', 'Nevertheless', 'In contrast'], correct: 1, explanation: '"Specifically" introduces the concrete details of their preparation.' },
  { id: 90, domain: 'D4', difficulty: 'Medium', passage: 'The new policy required all employees to complete monthly training. _______, compliance rates dropped to below 40 percent within three months.', question: 'Which transition best fits?', options: ['As a result', 'Despite this', 'Therefore', 'Similarly'], correct: 1, explanation: '"Despite this" shows that the mandate failed to achieve its intended effect.' },
  { id: 91, domain: 'D4', difficulty: 'Hard', passage: 'The research methodology was rigorous and the sample size substantial. _______, the study's findings have been widely replicated by independent teams across four continents.', question: 'Which transition best fits?', options: ['However', 'Unsurprisingly', 'In contrast', 'That said'], correct: 1, explanation: '"Unsurprisingly" signals that the replication is an expected outcome of the strong methodology.' },
  { id: 92, domain: 'D4', difficulty: 'Easy', passage: 'Reading fiction has been shown to improve empathy. _______, book clubs have seen a resurgence in popularity as people seek both connection and intellectual stimulation.', question: 'Which transition best fits?', options: ['Nevertheless', 'Separately', 'Meanwhile', 'In contrast'], correct: 2, explanation: '"Meanwhile" introduces a parallel trend happening at the same time as the research finding.' },
  { id: 93, domain: 'D4', difficulty: 'Medium', passage: 'The island nation had resisted foreign investment for decades. _______, a new government reversed this policy, opening the economy to global markets overnight.', question: 'Which transition best fits?', options: ['Similarly', 'Abruptly', 'Furthermore', 'As a result'], correct: 1, explanation: '"Abruptly" captures the sudden, dramatic reversal after decades of resistance.' },

  { id: 94, domain: 'D4', difficulty: 'Easy', passage: 'The new cafeteria menu offers healthier options. _______, participation in the school lunch program has increased by thirty percent.', question: 'Which transition best fits?', options: ['However', 'As a result', 'In contrast', 'Although'], correct: 1, explanation: '"As a result" connects the healthier menu (cause) to increased participation (effect).' },
  { id: 95, domain: 'D4', difficulty: 'Medium', passage: 'The organization spent years advocating for the new legislation. _______, when it finally passed, many of its key provisions had been removed.', question: 'Which transition best fits?', options: ['Furthermore', 'Similarly', 'Disappointingly', 'Therefore'], correct: 2, explanation: '"Disappointingly" captures the emotional contrast between years of advocacy and the weakened result.' },
  { id: 96, domain: 'D4', difficulty: 'Hard', passage: 'The novelist had been hailed as a literary genius in her debut. _______, her second work was panned by the same critics who had championed her first.', question: 'Which transition best fits?', options: ['Furthermore', 'Curiously', 'As a result', 'Accordingly'], correct: 1, explanation: '"Curiously" signals the unexpected reversal of critical opinion.' },
  { id: 97, domain: 'D4', difficulty: 'Easy', passage: 'The app was designed with simplicity in mind. _______, users can navigate it without any prior technical experience.', question: 'Which transition best fits?', options: ['However', 'Nevertheless', 'Consequently', 'In contrast'], correct: 2, explanation: '"Consequently" shows that the simple design leads directly to easy navigation.' },
  { id: 98, domain: 'D4', difficulty: 'Medium', passage: 'Early childhood education programs show strong returns on investment. _______, many local governments continue to cut funding for these programs.', question: 'Which transition best fits?', options: ['Therefore', 'Despite this', 'Similarly', 'Furthermore'], correct: 1, explanation: '"Despite this" shows that the funding cuts continue regardless of the proven returns.' },
  { id: 99, domain: 'D4', difficulty: 'Hard', passage: 'The merger was expected to streamline operations and reduce costs. _______, administrative overhead actually increased in the year following the consolidation.', question: 'Which transition best fits?', options: ['As planned', 'In contrast', 'Counterintuitively', 'Similarly'], correct: 2, explanation: '"Counterintuitively" signals that the result was the opposite of what was logically expected.' },
  { id: 100, domain: 'D4', difficulty: 'Hard', passage: 'Satellite imagery revealed the extent of the flooding within hours of the disaster. _______, rescue teams were able to prioritize the most severely affected areas.', question: 'Which transition best fits?', options: ['However', 'Armed with this data', 'In contrast', 'Regardless'], correct: 1, explanation: '"Armed with this data" shows how the information directly enabled the rescue teams' actions.' },
];
