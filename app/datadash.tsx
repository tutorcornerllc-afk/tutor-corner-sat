...
const QUESTIONS = [
  ...
  { id: 72, domain: 'D3', difficulty: 'Hard', question: 'A study shows correlation r=0.85 between study hours and GPA. Which conclusion is valid?', options: ['Study hours cause higher GPA', 'GPA causes more study hours', 'There is a strong positive association but causation is not proven', 'The relationship is not significant'], correct: 2, explanation: 'r=0.85 is a strong positive correlation, but correlation never implies causation alone.' },
  ...
  { id: 82, domain: 'D3', difficulty: 'Easy', question: 'Data: 5, 10, 15, 20, 25. Mean?', options: ['10', '20', '15', '25'], correct: 2, explanation: '(5+10+15+20+25)/5 = 75/5 = 15.' },
  { id: 83, domain: 'D3', difficulty: 'Easy', question: 'What is the range of: 3, 7, 12, 18, 22?', options: ['15', '19', '22', '12'], correct: 1, explanation: 'Range = max - min = 22 - 3 = 19.' },
  { id: 84, domain: 'D3', difficulty: 'Medium', question: 'P(rolling an even number on a fair die)?', options: ['1/3', '2/3', '1/2', '1/6'], correct: 2, explanation: 'Even numbers: 2, 4, 6. Three out of six = 1/2.' },
  { id: 85, domain: 'D3', difficulty: 'Medium', question: 'Data: 4, 8, 8, 9, 11. Median?', options: ['8', '9', '8.5', '11'], correct: 0, explanation: 'Sorted, middle value (3rd of 5) = 8.' },
  { id: 86, domain: 'D3', difficulty: 'Hard', question: 'Outlier effect: dataset mean=50. Add value 200. New mean moves:', options: ['Down significantly', 'Up significantly', 'Stays same', 'Becomes median'], correct: 1, explanation: 'Adding a large outlier pulls the mean up significantly. Mean is sensitive to outliers.' },
  { id: 87, domain: 'D3', difficulty: 'Medium', question: 'Survey asks 100 people their favorite color. This is:', options: ['Continuous data', 'Quantitative data', 'Categorical data', 'Ordinal data'], correct: 2, explanation: 'Color is a category (no numeric value) -> categorical/nominal data.' },
  { id: 88, domain: 'D3', difficulty: 'Hard', question: 'Two events: P(A)=0.6, P(B)=0.3, P(A|B)=0.6. Are they independent?', options: ['Yes, P(A|B)=P(A)', 'No, they overlap', 'Cannot determine', 'No, P(A|B) must equal 0'], correct: 0, explanation: 'Events are independent if P(A|B) = P(A). Here 0.6 = 0.6, so yes, independent.' },
  { id: 89, domain: 'D1', difficulty: 'Medium', question: 'Line of best fit: y = 2x + 5. Predict y when x = 8.', options: ['16', '21', '26', '13'], correct: 1, explanation: 'y = 2(8) + 5 = 16 + 5 = 21.' },
  { id: 90, domain: 'D3', difficulty: 'Easy', question: 'Which measure is NOT affected by outliers?', options: ['Mean', 'Median', 'Range', 'Standard deviation'], correct: 1, explanation: 'Median is the middle value and is resistant to extreme outliers.' },
  { id: 91, domain: 'D3', difficulty: 'Hard', question: '10 students scored: 60,65,70,70,75,75,80,85,90,100. Q1=?', options: ['67.5', '70', '65', '72.5'], correct: 0, explanation: 'Q1 is median of lower half (60,65,70,70,75). Q1 = avg of 2nd and 3rd = (65+70)/2 = 67.5.' },
  { id: 92, domain: 'D3', difficulty: 'Medium', question: 'A fair coin flipped 4 times. P(all heads)?', options: ['1/4', '1/8', '1/16', '1/2'], correct: 2, explanation: '(1/2)^4 = 1/16.' },
  { id: 93, domain: 'D3', difficulty: 'Hard', question: 'Histogram is skewed right. Which is usually true?', options: ['Mean < Median', 'Mean = Median', 'Mean > Median', 'Median = Mode'], correct: 2, explanation: 'In right-skewed distributions, the long tail pulls the mean above the median.' },
  { id: 94, domain: 'D3', difficulty: 'Medium', question: '60 students: 40% prefer math. How many prefer math?', options: ['20', '40', '24', '36'], correct: 2, explanation: '0.40 x 60 = 24.' },
  { id: 95, domain: 'D2', difficulty: 'Hard', question: 'Population model: P(t)=500(1.04)^t. Growth rate?', options: ['500%', '4%', '40%', '104%'], correct: 1, explanation: 'In P = P0(1+r)^t, the base (1.04) means r = 0.04 = 4% annual growth.' },
  { id: 96, domain: 'D3', difficulty: 'Easy', question: 'P(not rolling a 6 on a fair die)?', options: ['1/6', '5/6', '4/6', '1/3'], correct: 1, explanation: 'P(not 6) = 1 - 1/6 = 5/6.' },
  { id: 97, domain: 'D3', difficulty: 'Hard', question: 'Correlation r = -0.02. This means:', options: ['Strong negative relationship', 'Moderate negative relationship', 'Almost no linear relationship', 'Perfect negative correlation'], correct: 2, explanation: 'r close to 0 means virtually no linear relationship between variables.' },
  { id: 98, domain: 'D3', difficulty: 'Medium', question: 'Class of 30: 10 failed, 20 passed. P(passed)?', options: ['1/3', '2/3', '3/2', '1/2'], correct: 1, explanation: '20/30 = 2/3.' },
  { id: 99, domain: 'D3', difficulty: 'Hard', question: 'Five-number summary: 10, 25, 40, 60, 90. Which is Q3?', options: ['40', '60', '25', '90'], correct: 1, explanation: 'Five-number summary is: min, Q1, median, Q3, max. Q3 = 60.' },
  { id: 100, domain: 'D1', difficulty: 'Hard', question: 'Residual plot shows a curved pattern. This suggests:', options: ['Linear model is perfect', 'A non-linear model would fit better', 'The data has no trend', 'R-squared = 1'], correct: 1, explanation: 'Curved residual patterns indicate the linear model misses systematic patterns -> non-linear model needed.' },
];
