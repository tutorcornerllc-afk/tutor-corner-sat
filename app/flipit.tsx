...
const QUESTIONS = [
  ...
  { id: 51, domain: 'D3', difficulty: 'Easy', sentence: 'The data _____ collected over three years.', blank: 'collected over three years', optionA: 'was', optionB: 'were', correct: 'A', explanation: '"Data" can be singular or plural, but in the SAT context it is typically treated as singular: "data was collected."' },
  { id: 52, domain: 'D3', difficulty: 'Easy', sentence: 'Each of the students _____ required to submit a portfolio.', blank: 'required to submit a portfolio', optionA: 'is', optionB: 'are', correct: 'A', explanation: '"Each" is always singular and takes a singular verb.' },
  { id: 53, domain: 'D3', difficulty: 'Medium', sentence: 'Neither the manager nor the employees _____ aware of the policy change.', blank: 'aware of the policy change', optionA: 'was', optionB: 'were', correct: 'B', explanation: 'With neither/nor, the verb agrees with the closer subject. "Employees" is plural → "were."' },
  { id: 54, domain: 'D3', difficulty: 'Medium', sentence: 'The committee _____ voted to approve the new budget.', blank: 'voted to approve the new budget', optionA: 'have', optionB: 'has', correct: 'B', explanation: '"Committee" is a collective noun acting as a single unit → singular verb "has."' },
  { id: 55, domain: 'D3', difficulty: 'Easy', sentence: 'One of the books _____ missing from the shelf.', blank: 'missing from the shelf', optionA: 'is', optionB: 'are', correct: 'A', explanation: '"One" is the subject, not "books." One is singular → "is."' },
  { id: 56, domain: 'D3', difficulty: 'Hard', sentence: 'The number of applicants _____ increased significantly this year.', blank: 'increased significantly this year', optionA: 'has', optionB: 'have', correct: 'A', explanation: '"The number" (not "a number") is singular → "has increased."' },
  { id: 57, domain: 'D3', difficulty: 'Medium', sentence: 'Sports _____ her favorite pastime since childhood.', blank: 'her favorite pastime since childhood', optionA: 'has been', optionB: 'have been', correct: 'A', explanation: 'When "sports" refers to a single concept/activity, it takes singular: "has been."' },
  { id: 58, domain: 'D3', difficulty: 'Hard', sentence: 'A series of unfortunate events _____ led to the company's downfall.', blank: 'led to the company's downfall', optionA: 'has', optionB: 'have', correct: 'A', explanation: '"A series" is the subject (singular noun) → "has led."' },
  { id: 59, domain: 'D3', difficulty: 'Easy', sentence: 'She works more _____ than her colleagues.', blank: 'than her colleagues', optionA: 'efficient', optionB: 'efficiently', correct: 'B', explanation: 'Adverbs modify verbs. "Works efficiently" is correct; "efficient" is an adjective.' },
  { id: 60, domain: 'D3', difficulty: 'Medium', sentence: 'The results were _____ better than expected.', blank: 'better than expected', optionA: 'significant', optionB: 'significantly', correct: 'B', explanation: '"Significantly" modifies the adjective "better" -- an adverb is needed here.' },
  ...
  { id: 61, domain: 'D3', difficulty: 'Hard', sentence: 'The principal effect of the new policy was to reduce absenteeism.', blank: 'effect', optionA: 'effect', optionB: 'affect', correct: 'A', explanation: '"Effect" is a noun meaning result or outcome. "Affect" is typically a verb. "The principal effect" (noun) is correct.' },
  { id: 62, domain: 'D3', difficulty: 'Hard', sentence: 'There are _____ options available than we originally expected.', blank: 'options available', optionA: 'fewer', optionB: 'less', correct: 'A', explanation: '"Fewer" is used with countable nouns (options). "Less" is used with uncountable quantities.' },
  { id: 63, domain: 'D3', difficulty: 'Medium', sentence: 'Who _____ the responsibility for approving the final budget?', blank: 'the responsibility', optionA: 'bears', optionB: 'bares', correct: 'A', explanation: '"Bears" means carries or holds (responsibility). "Bares" means exposes.' },
  { id: 64, domain: 'D3', difficulty: 'Hard', sentence: 'The board _____ its decision after reviewing new evidence.', blank: 'its decision', optionA: 'revised', optionB: 'reverted', correct: 'A', explanation: '"Revised" means changed or updated. "Reverted" means returned to an original state -- wrong here.' },
  { id: 65, domain: 'D3', difficulty: 'Hard', sentence: 'Her novel had a profound _____ on contemporary literature.', blank: 'on contemporary literature', optionA: 'affect', optionB: 'effect', correct: 'B', explanation: '"Effect" (noun) is the result. "Affect" is typically a verb. The sentence needs a noun after "profound."' },
  { id: 66, domain: 'D3', difficulty: 'Hard', sentence: 'The data suggests that _____ of the two candidates is qualified for the role.', blank: 'of the two candidates', optionA: 'neither', optionB: 'none', correct: 'A', explanation: '"Neither" is used for exactly two. "None" is used for three or more.' },
  { id: 67, domain: 'D3', difficulty: 'Hard', sentence: 'He will _____ the opportunity to present his research next month.', blank: 'the opportunity', optionA: 'have', optionB: 'of had', correct: 'A', explanation: '"Will have" is the correct future tense. "Will of had" is not a valid construction.' },
  { id: 68, domain: 'D3', difficulty: 'Medium', sentence: 'The findings were _____ to the entire research community.', blank: 'to the entire research community', optionA: 'unprecedented', optionB: 'unpresidented', correct: 'A', explanation: '"Unprecedented" means never done before. "Unpresidented" is not a word.' },
  { id: 69, domain: 'D3', difficulty: 'Hard', sentence: 'I _____ recommend this candidate without reservation.', blank: 'this candidate', optionA: 'can', optionB: 'may', correct: 'A', explanation: '"Can" expresses ability/confidence. "May" expresses permission. In a recommendation, "can" is standard.' },
  { id: 70, domain: 'D3', difficulty: 'Hard', sentence: 'The city council will _____ the proposal at Thursday's meeting.', blank: 'the proposal', optionA: 'table', optionB: 'tale', correct: 'A', explanation: '"Table" (in American English) means to postpone. "Tale" is a story -- nonsensical here.' },

  { id: 71, domain: 'D3', difficulty: 'Easy', sentence: 'She felt _____ about the outcome of the negotiation.', blank: 'about the outcome', optionA: 'confident', optionB: 'confidently', correct: 'A', explanation: '"Felt" is a linking verb; it takes an adjective complement. "Confident" (adjective) is correct. "Confidently" is an adverb.' },
  { id: 72, domain: 'D3', difficulty: 'Medium', sentence: 'The professor speaks more _____ than anyone else in the department.', blank: 'than anyone else', optionA: 'clear', optionB: 'clearly', correct: 'B', explanation: '"Clearly" is an adverb modifying "speaks." Adverbs modify verbs; adjectives modify nouns.' },
  { id: 73, domain: 'D3', difficulty: 'Easy', sentence: 'Between the two candidates, Sofia is the _____ qualified.', blank: 'qualified', optionA: 'most', optionB: 'more', correct: 'B', explanation: '"More" is the comparative form, used when comparing exactly two things. "Most" is superlative (three or more).' },
  { id: 74, domain: 'D3', difficulty: 'Hard', sentence: 'The evidence suggests that the defendant _____ have committed the crime.', blank: 'have committed', optionA: 'could not', optionB: 'could of', correct: 'A', explanation: '"Could not have" is correct. "Could of" is a common misspelling of "could have" -- never grammatically correct.' },
  { id: 75, domain: 'D3', difficulty: 'Medium', sentence: 'The company requires that every employee _____ the new protocol.', blank: 'the new protocol', optionA: 'follow', optionB: 'follows', correct: 'A', explanation: 'The subjunctive mood follows "requires that." The subjunctive uses the base form: "follow" not "follows."' },
  { id: 76, domain: 'D3', difficulty: 'Hard', sentence: 'Had she known the truth, she _____ differently.', blank: 'differently', optionA: 'would have acted', optionB: 'would act', correct: 'A', explanation: 'Inverted conditional (had + past participle) signals a past hypothetical. Use "would have + past participle."' },
  { id: 77, domain: 'D3', difficulty: 'Medium', sentence: 'I wish I _____ more time to finish the project properly.', blank: 'more time', optionA: 'had', optionB: 'have', correct: 'A', explanation: '"Wish" triggers the subjunctive/past tense to express an unreal desire. "Had" (not "have") is correct.' },
  { id: 78, domain: 'D3', difficulty: 'Hard', sentence: 'Not only _____ she finish first, but she also broke the record.', blank: 'she finish first', optionA: 'she did', optionB: 'did she', correct: 'B', explanation: '"Not only" at the start of a clause triggers subject-auxiliary inversion: "did she" not "she did."' },
  { id: 79, domain: 'D3', difficulty: 'Medium', sentence: 'The number of applicants who meet the criteria _____ surprisingly small.', blank: 'meet the criteria', optionA: 'are', optionB: 'is', correct: 'B', explanation: '"The number" is the subject (singular) → "is." "A number of" would be plural. "The number" = singular.' },
  { id: 80, domain: 'D3', difficulty: 'Hard', sentence: 'Either the manager or the assistants _____ responsible for the error.', blank: 'responsible for the error', optionA: 'is', optionB: 'are', correct: 'B', explanation: 'Either/or: the verb agrees with the closer subject. "Assistants" is plural → "are."' },
  { id: 81, domain: 'D3', difficulty: 'Easy', sentence: 'She is one of the students who _____ excelled this semester.', blank: 'excelled this semester', optionA: 'has', optionB: 'have', correct: 'B', explanation: 'The antecedent of "who" is "students" (plural), so use "have." One of the students [who have excelled].' },
  { id: 82, domain: 'D3', difficulty: 'Hard', sentence: 'The findings suggest that more research _____ needed before any conclusions can be drawn.', blank: 'needed before', optionA: 'are', optionB: 'is', correct: 'B', explanation: '"Research" is an uncountable noun -- always singular. "More research is needed."' },
  { id: 83, domain: 'D3', difficulty: 'Medium', sentence: 'Each of the proposals _____ reviewed by the committee before voting.', blank: 'reviewed by the committee', optionA: 'was', optionB: 'were', correct: 'A', explanation: '"Each" is always singular regardless of the noun that follows. "Each...was reviewed."' },
  { id: 84, domain: 'D3', difficulty: 'Hard', sentence: 'The quality of the submissions _____ improved dramatically this year.', blank: 'improved dramatically', optionA: 'have', optionB: 'has', correct: 'B', explanation: '"Quality" is the subject (singular), not "submissions." "The quality...has improved."' },
  { id: 85, domain: 'D3', difficulty: 'Medium', sentence: 'No sooner _____ she arrived than the meeting began.', blank: 'she arrived', optionA: 'had', optionB: 'did', correct: 'A', explanation: '"No sooner...than" uses past perfect: "No sooner had she arrived than..." -- not simple past.' },

  { id: 86, domain: 'D3', difficulty: 'Hard', sentence: 'The jury found the defendant guilty of all _____ charges.', blank: 'all charges', optionA: 'levied', optionB: 'alleged', correct: 'B', explanation: '"Alleged" means claimed but not yet proven. Charges are alleged until proven at trial.' },
  { id: 87, domain: 'D3', difficulty: 'Medium', sentence: 'She has _____ interest in pursuing a career in medicine.', blank: 'interest in pursuing', optionA: 'little', optionB: 'few', correct: 'A', explanation: '"Little" modifies uncountable nouns like "interest." "Few" is for countable nouns.' },
  { id: 88, domain: 'D3', difficulty: 'Hard', sentence: 'The committee has yet to _____ a final decision on the matter.', blank: 'a final decision', optionA: 'reach', optionB: 'make', correct: 'B', explanation: 'Both work, but "make a decision" is the standard idiomatic collocation in formal English.' },
  { id: 89, domain: 'D3', difficulty: 'Medium', sentence: 'She _____ the entire novel in one sitting last Saturday.', blank: 'the entire novel', optionA: 'read', optionB: 'had read', correct: 'A', explanation: 'Simple past "read" is correct for a completed action with a specific past time marker (last Saturday).' },
  { id: 90, domain: 'D3', difficulty: 'Hard', sentence: 'By the time the guests arrived, she _____ dinner.', blank: 'dinner', optionA: 'prepared', optionB: 'had prepared', correct: 'B', explanation: 'Past perfect "had prepared" shows an action completed before another past action (guests arriving).' },
  { id: 91, domain: 'D3', difficulty: 'Medium', sentence: 'He is _____ of his team than any previous coach has been.', blank: 'of his team', optionA: 'more proud', optionB: 'prouder', correct: 'A', explanation: 'Both forms are acceptable, but "more proud" is preferred in formal writing with a "than" clause.' },
  { id: 92, domain: 'D3', difficulty: 'Hard', sentence: 'The regulations apply to _____ submits an application after the deadline.', blank: 'submits an application', optionA: 'whoever', optionB: 'whomever', correct: 'A', explanation: '"Whoever" is a subject pronoun. It's the subject of "submits." Test: replace with he/she (whoever = he submits).' },
  { id: 93, domain: 'D3', difficulty: 'Medium', sentence: 'There were _____ applicants than the committee expected.', blank: 'than the committee expected', optionA: 'less', optionB: 'fewer', correct: 'B', explanation: '"Fewer" is used with countable nouns (applicants). "Less" is for uncountable quantities.' },
  { id: 94, domain: 'D3', difficulty: 'Hard', sentence: 'The board insisted that each proposal _____ reviewed individually.', blank: 'reviewed individually', optionA: 'be', optionB: 'is', correct: 'A', explanation: '"Insisted that" triggers the subjunctive mood: "be reviewed" (base form, not "is reviewed").' },
  { id: 95, domain: 'D3', difficulty: 'Hard', sentence: 'If the study _____ conducted properly, the results would be more reliable.', blank: 'conducted properly', optionA: 'were', optionB: 'was', correct: 'A', explanation: 'Subjunctive "were" is used in contrary-to-fact conditionals, regardless of subject.' },
];
