...
const QUESTIONS = [
  ...
  { id: 51, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the capitalization error', sentence: 'My sister is studying Biology at the University of arizona.', words: ['My', 'sister', 'is', 'studying', 'Biology', 'at', 'the', 'University', 'of', 'arizona.'], errorIndex: 9, errorType: 'capitalization', explanation: '"Arizona" is a proper noun (state name) and must be capitalized.' },
  { id: 52, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the punctuation error', sentence: 'She loves hiking, swimming and, cycling in her free time.', words: ['She', 'loves', 'hiking,', 'swimming', 'and,', 'cycling', 'in', 'her', 'free', 'time.'], errorIndex: 4, errorType: 'punctuation', explanation: 'The comma belongs after "swimming" (before "and"), not after "and." Remove the comma after "and."' },
  { id: 53, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the repeated word', sentence: 'He said that that the meeting would be postponed until further notice.', words: ['He', 'said', 'that', 'that', 'the', 'meeting', 'would', 'be', 'postponed', 'until', 'further', 'notice.'], errorIndex: 3, errorType: 'repeated', explanation: '"That" is repeated. Only one "that" is needed after "said."' },
  { id: 54, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the punctuation error', sentence: 'Dr. Stevens who is the head of the department, approved the new curriculum.', words: ['Dr.', 'Stevens', 'who', 'is', 'the', 'head', 'of', 'the', 'department,', 'approved', 'the', 'new', 'curriculum.'], errorIndex: 2, errorType: 'punctuation', explanation: '"Who is the head of the department" is a nonrestrictive clause and needs a comma before "who." Add a comma after "Stevens."' },
  { id: 55, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the capitalization error', sentence: 'The french revolution began in 1789 and had far-reaching consequences.', words: ['The', 'french', 'revolution', 'began', 'in', '1789', 'and', 'had', 'far-reaching', 'consequences.'], errorIndex: 1, errorType: 'capitalization', explanation: '"French" is a proper adjective derived from the proper noun "France" and must be capitalized.' },
  { id: 56, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the punctuation error', sentence: 'The results were clear however, the team decided to run additional tests.', words: ['The', 'results', 'were', 'clear', 'however,', 'the', 'team', 'decided', 'to', 'run', 'additional', 'tests.'], errorIndex: 4, errorType: 'punctuation', explanation: '"However" connecting two independent clauses needs a semicolon before it: "clear; however,"' },
  { id: 57, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: 'Its important to proofread your work before submitting it to the professor.', words: ["It's", 'important', 'to', 'proofread', 'your', 'work', 'before', 'submitting', 'it', 'to', 'the', 'professor.'], errorIndex: 0, errorType: 'punctuation', explanation: '"Its" (possessive) needs to be "It's" (it is). The sentence means "It is important."' },
  { id: 58, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the capitalization error', sentence: 'She read shakespeare in her english class last Semester.', words: ['She', 'read', 'shakespeare', 'in', 'her', 'english', 'class', 'last', 'Semester.'], errorIndex: 2, errorType: 'capitalization', explanation: '"Shakespeare" is a proper noun (name of a person) and must be capitalized.' },
  { id: 59, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the repeated word', sentence: 'The the proposal was rejected by the committee on Monday.', words: ['The', 'the', 'proposal', 'was', 'rejected', 'by', 'the', 'committee', 'on', 'Monday.'], errorIndex: 1, errorType: 'repeated', explanation: '"The" is duplicated at the beginning of the sentence.' },
  { id: 60, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the punctuation error', sentence: 'After finishing her degree she plans to travel to Southeast Asia.', words: ['After', 'finishing', 'her', 'degree', 'she', 'plans', 'to', 'travel', 'to', 'Southeast', 'Asia.'], errorIndex: 4, errorType: 'punctuation', explanation: 'An introductory adverbial phrase needs a comma after it. Add a comma after "degree."' },
  ...
  { id: 61, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "The researchers conclusions, which contradicted decades of prior work, were met with immediate skepticism.", words: ['The', "researchers'", 'conclusions,', 'which', 'contradicted', 'decades', 'of', 'prior', 'work,', 'were', 'met', 'with', 'immediate', 'skepticism.'], errorIndex: 1, errorType: 'punctuation', explanation: '"Researchers" is possessive here -- it should be "researchers'" (with apostrophe). Without it, "The researchers conclusions" is a noun pile-up.' },
  { id: 62, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: 'Although she studied for weeks she still struggled with the advanced calculus problems.', words: ['Although', 'she', 'studied', 'for', 'weeks', 'she', 'still', 'struggled', 'with', 'the', 'advanced', 'calculus', 'problems.'], errorIndex: 4, errorType: 'punctuation', explanation: 'An introductory subordinate clause ("Although she studied for weeks") must be followed by a comma before the main clause.' },
  { id: 63, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the capitalization error', sentence: 'Professor Nguyen teaches environmental science and biology at the university each Fall.', words: ['Professor', 'Nguyen', 'teaches', 'environmental', 'science', 'and', 'biology', 'at', 'the', 'university', 'each', 'Fall.'], errorIndex: 11, errorType: 'capitalization', explanation: 'Seasons (fall, winter, spring, summer) are not capitalized in standard English unless part of a proper name.' },
  { id: 64, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "It's the teams responsibility to ensure all data is verified before submission.", words: ["It's", 'the', "teams'", 'responsibility', 'to', 'ensure', 'all', 'data', 'is', 'verified', 'before', 'submission.'], errorIndex: 2, errorType: 'punctuation', explanation: '"Team's" (singular possessive) is needed, not "teams'" (plural possessive). One team's responsibility.' },
  { id: 65, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: 'The experiment which was conducted over six months yielded surprising results.', words: ['The', 'experiment', 'which', 'was', 'conducted', 'over', 'six', 'months', 'yielded', 'surprising', 'results.'], errorIndex: 2, errorType: 'punctuation', explanation: '"Which was conducted over six months" is a nonrestrictive clause -- it needs commas around it. A comma is missing before "which."' },
  { id: 66, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the capitalization error', sentence: 'The committee reviewed the federal Budget proposal submitted by the Treasury Department.', words: ['The', 'committee', 'reviewed', 'the', 'federal', 'Budget', 'proposal', 'submitted', 'by', 'the', 'Treasury', 'Department.'], errorIndex: 5, errorType: 'capitalization', explanation: '"Budget" is a common noun in this context and should not be capitalized unless part of a specific formal title.' },
  { id: 67, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "We need to consider however the long-term implications of this policy change.", words: ['We', 'need', 'to', 'consider', 'however', 'the', 'long-term', 'implications', 'of', 'this', 'policy', 'change.'], errorIndex: 4, errorType: 'punctuation', explanation: '"However" used as a parenthetical adverb needs commas on both sides: "consider, however, the long-term..."' },
  { id: 68, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "The CEO announced that the company's quarterly profits had exceeded, analysts expectations.", words: ['The', 'CEO', 'announced', 'that', 'the', "company's", 'quarterly', 'profits', 'had', 'exceeded,', "analysts'", 'expectations.'], errorIndex: 9, errorType: 'punctuation', explanation: 'No comma belongs after "exceeded." The comma separates the verb from its object ("analysts' expectations"), which is incorrect.' },
  { id: 69, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the capitalization error', sentence: 'The civil war had a profound impact on american literature and culture.', words: ['The', 'civil', 'war', 'had', 'a', 'profound', 'impact', 'on', 'american', 'literature', 'and', 'culture.'], errorIndex: 8, errorType: 'capitalization', explanation: '"American" is a proper adjective derived from "America" and must be capitalized.' },
  { id: 70, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "She asked whether the deadline had already passed, and, whether she could still submit.", words: ['She', 'asked', 'whether', 'the', 'deadline', 'had', 'already', 'passed,', 'and,', 'whether', 'she', 'could', 'still', 'submit.'], errorIndex: 8, errorType: 'punctuation', explanation: 'No comma after "and" when connecting two parallel subordinate clauses. "and, whether" should be "and whether."' },

  { id: 71, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the punctuation error', sentence: 'The bridge which connects the two cities was built in 1987 and still carries heavy traffic daily.', words: ['The', 'bridge', 'which', 'connects', 'the', 'two', 'cities', 'was', 'built', 'in', '1987', 'and', 'still', 'carries', 'heavy', 'traffic', 'daily.'], errorIndex: 2, errorType: 'punctuation', explanation: '"Which connects the two cities" is a nonrestrictive clause -- it adds extra info and should be set off by commas. A comma is missing before "which."' },
  { id: 72, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the capitalization error', sentence: 'The President of the united states delivered a speech on climate change.', words: ['The', 'President', 'of', 'the', 'united', 'states', 'delivered', 'a', 'speech', 'on', 'climate', 'change.'], errorIndex: 4, errorType: 'capitalization', explanation: '"United States" is a proper noun (name of a country) -- both words must be capitalized.' },
  { id: 73, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: 'She asked her professor if she could submit the paper late; however she had already missed the deadline.', words: ['She', 'asked', 'her', 'professor', 'if', 'she', 'could', 'submit', 'the', 'paper', 'late;', 'however', 'she', 'had', 'already', 'missed', 'the', 'deadline.'], errorIndex: 11, errorType: 'punctuation', explanation: '"However" as a conjunctive adverb needs a comma after it: "late; however, she had already..."' },
  { id: 74, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the repeated word', sentence: 'The scientist carefully carefully documented every step of the experiment in her notebook.', words: ['The', 'scientist', 'carefully', 'carefully', 'documented', 'every', 'step', 'of', 'the', 'experiment', 'in', 'her', 'notebook.'], errorIndex: 3, errorType: 'repeated', explanation: '"Carefully" is repeated. Only one adverb is needed.' },
  { id: 75, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the capitalization error', sentence: 'She studied both latin and greek before enrolling in the Classics department.', words: ['She', 'studied', 'both', 'latin', 'and', 'greek', 'before', 'enrolling', 'in', 'the', 'Classics', 'department.'], errorIndex: 3, errorType: 'capitalization', explanation: '"Latin" is a proper adjective (derived from "Latium," a proper noun) and must be capitalized.' },
  { id: 76, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "The results which were unexpected, forced the team to redesign the entire study from scratch.", words: ['The', 'results,', 'which', 'were', 'unexpected,', 'forced', 'the', 'team', 'to', 'redesign', 'the', 'entire', 'study', 'from', 'scratch.'], errorIndex: 0, errorType: 'punctuation', explanation: 'The nonrestrictive clause "which were unexpected" needs a comma before "which," not after "results." "The results, which were unexpected, forced..." -- the first comma is the error here as written.' },
  { id: 77, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the capitalization error', sentence: 'My history teacher loves the renaissance period, especially italian painting.', words: ['My', 'history', 'teacher', 'loves', 'the', 'renaissance', 'period,', 'especially', 'italian', 'painting.'], errorIndex: 5, errorType: 'capitalization', explanation: '"Renaissance" is a proper noun referring to a specific historical period and must be capitalized.' },
  { id: 78, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the punctuation error', sentence: 'He wanted to travel however, he could not afford a plane ticket.', words: ['He', 'wanted', 'to', 'travel', 'however,', 'he', 'could', 'not', 'afford', 'a', 'plane', 'ticket.'], errorIndex: 4, errorType: 'punctuation', explanation: '"However" connecting two independent clauses needs a semicolon before it: "travel; however, he could not..."' },
  { id: 79, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the capitalization error', sentence: 'The mayor announced that the new public library would open next Spring.', words: ['The', 'mayor', 'announced', 'that', 'the', 'new', 'public', 'library', 'would', 'open', 'next', 'Spring.'], errorIndex: 11, errorType: 'capitalization', explanation: 'Seasons are not capitalized in standard English. "Spring" should be lowercase: "next spring."' },
  { id: 80, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the punctuation error', sentence: 'The CEO of the company, who was appointed last year announced a major restructuring plan.', words: ['The', 'CEO', 'of', 'the', 'company,', 'who', 'was', 'appointed', 'last', 'year', 'announced', 'a', 'major', 'restructuring', 'plan.'], errorIndex: 9, errorType: 'punctuation', explanation: '"Who was appointed last year" is a nonrestrictive clause. It needs a comma after "year" to close the clause before "announced."' },
  { id: 81, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "The authors conclusion that climate change is accelerating is supported by decades of data.", words: ["The", "author's", "conclusion", "that", "climate", "change", "is", "accelerating", "is", "supported", "by", "decades", "of", "data."], errorIndex: 0, errorType: 'punctuation', explanation: '"Author's" (possessive) needs an apostrophe. "The authors conclusion" -- "authors" is missing the apostrophe before "s."' },
  { id: 82, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the repeated word', sentence: 'Please submit your your application before the deadline on Friday afternoon.', words: ['Please', 'submit', 'your', 'your', 'application', 'before', 'the', 'deadline', 'on', 'Friday', 'afternoon.'], errorIndex: 3, errorType: 'repeated', explanation: '"Your" is repeated. Only one is needed.' },
  { id: 83, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the capitalization error', sentence: 'She studied spanish in high school before taking advanced courses at the university.', words: ['She', 'studied', 'spanish', 'in', 'high', 'school', 'before', 'taking', 'advanced', 'courses', 'at', 'the', 'university.'], errorIndex: 2, errorType: 'capitalization', explanation: '"Spanish" is a proper adjective (derived from "Spain") and must always be capitalized.' },
  { id: 84, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "Scientists have long studied the effects of caffeine on sleep yet few studies have examined its long-term impact.", words: ['Scientists', 'have', 'long', 'studied', 'the', 'effects', 'of', 'caffeine', 'on', 'sleep', 'yet', 'few', 'studies', 'have', 'examined', 'its', 'long-term', 'impact.'], errorIndex: 10, errorType: 'punctuation', explanation: '"Yet" connecting two independent clauses needs a comma before it: "on sleep, yet few studies..."' },
  { id: 85, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the capitalization error', sentence: 'The board voted to establish a new committee for reviewing Environmental policy.', words: ['The', 'board', 'voted', 'to', 'establish', 'a', 'new', 'committee', 'for', 'reviewing', 'Environmental', 'policy.'], errorIndex: 10, errorType: 'capitalization', explanation: '"Environmental" is a common adjective here, not part of a proper title. It should not be capitalized mid-sentence.' },

  { id: 86, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: 'The students who participated in the study gave their consent however, some withdrew before completion.', words: ['The','students','who','participated','in','the','study','gave','their','consent','however,','some','withdrew','before','completion.'], errorIndex: 10, errorType: 'punctuation', explanation: '"However" joining two independent clauses needs a semicolon before it, not just a comma: "consent; however, some withdrew."' },
  { id: 87, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the capitalization error', sentence: 'She majored in political science and minored in economics at northwestern university.', words: ['She','majored','in','political','science','and','minored','in','economics','at','northwestern','university.'], errorIndex: 10, errorType: 'capitalization', explanation: '"Northwestern University" is a proper noun (name of a specific institution). Both words must be capitalized.' },
  { id: 88, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the punctuation error', sentence: "The teams decision to restructure was controversial but ultimately successful.", words: ['The',"team's",'decision','to','restructure','was','controversial','but','ultimately','successful.'], errorIndex: 0, errorType: 'punctuation', explanation: '"Team's" requires an apostrophe to show possession. "The teams decision" is missing the apostrophe.' },
  { id: 89, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the repeated word', sentence: 'Please make sure that that all documents are submitted by Friday.', words: ['Please','make','sure','that','that','all','documents','are','submitted','by','Friday.'], errorIndex: 4, errorType: 'repeated', explanation: '"That" is repeated unnecessarily. Only one "that" is needed.' },
  { id: 90, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the capitalization error', sentence: 'The prime minister announced that parliament would reconvene in January.', words: ['The','prime','minister','announced','that','parliament','would','reconvene','in','January.'], errorIndex: 1, errorType: 'capitalization', explanation: 'When used as a title before a name, "Prime Minister" is capitalized. Here it functions as a title without a name -- style guides vary, but many capitalize it in this context.' },
  { id: 91, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the punctuation error', sentence: "Its a well-known fact that regular exercise improves mental health outcomes.", words: ["Its",'a','well-known','fact','that','regular','exercise','improves','mental','health','outcomes.'], errorIndex: 0, errorType: 'punctuation', explanation: '"Its" should be "It's" (it is). The contraction needs an apostrophe.' },
  { id: 92, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: 'The experiment yielded three key results: increased efficiency, reduced waste and lower costs.', words: ['The','experiment','yielded','three','key','results:','increased','efficiency,','reduced','waste','and','lower','costs.'], errorIndex: 10, errorType: 'punctuation', explanation: 'In a series of three or more items, a comma before "and" (Oxford comma) is standard in formal writing: "waste, and lower costs."' },
  { id: 93, domain: 'D3', difficulty: 'Easy', instruction: 'Tap the capitalization error', sentence: 'She studied the works of Shakespeare and other english dramatists.', words: ['She','studied','the','works','of','Shakespeare','and','other','english','dramatists.'], errorIndex: 8, errorType: 'capitalization', explanation: '"English" is a proper adjective (derived from England) and must be capitalized.' },
  { id: 94, domain: 'D3', difficulty: 'Hard', instruction: 'Tap the punctuation error', sentence: "The CEOs decision to expand internationally surprised many industry analysts.", words: ["The","CEO's","decision","to","expand","internationally","surprised","many","industry","analysts."], errorIndex: 0, errorType: 'punctuation', explanation: '"CEO's" needs an apostrophe to form the possessive. "CEOs decision" is missing it.' },
  { id: 95, domain: 'D3', difficulty: 'Medium', instruction: 'Tap the capitalization error', sentence: 'The study analyzed data from three continents: europe, Asia, and North America.', words: ['The','study','analyzed','data','from','three','continents:','europe,','Asia,','and','North','America.'], errorIndex: 7, errorType: 'capitalization', explanation: '"Europe" is a proper noun (continent name) and must be capitalized.' },
];
