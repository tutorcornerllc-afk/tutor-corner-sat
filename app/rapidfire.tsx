...
const QUESTIONS = [
  ...
  { id: 76, domain: 'D1', difficulty: 'Easy', question: 'Evaluate: 4² − 2³', options: ['4', '8', '12', '6'], correct: 1, explanation: '16 − 8 = 8.' },
  { id: 77, domain: 'D1', difficulty: 'Easy', question: 'Solve: 4(x − 2) = 12', options: ['3', '4', '5', '2'], correct: 2, explanation: '4x − 8 = 12 → 4x = 20 → x = 5.' },
  { id: 78, domain: 'D1', difficulty: 'Medium', question: 'If f(x) = 4x − 1, find f(−2).', options: ['−9', '−7', '7', '9'], correct: 0, explanation: 'f(−2) = 4(−2) − 1 = −8 − 1 = −9.' },
  { id: 79, domain: 'D1', difficulty: 'Medium', question: 'Solve: x² − 5x + 6 = 0', options: ['x=2 or x=3', 'x=−2 or x=−3', 'x=1 or x=6', 'x=−1 or x=−6'], correct: 0, explanation: 'Factor: (x−2)(x−3)=0 → x=2 or x=3.' },
  { id: 80, domain: 'D1', difficulty: 'Hard', question: 'System: x+y=7, x−y=3. Find x.', options: ['2', '3', '5', '4'], correct: 2, explanation: 'Add equations: 2x=10 → x=5.' },
  { id: 81, domain: 'D2', difficulty: 'Easy', question: '√(144) = ?', options: ['11', '14', '12', '13'], correct: 2, explanation: '12² = 144 so √144 = 12.' },
  { id: 82, domain: 'D2', difficulty: 'Medium', question: 'Simplify: (x³)(x⁴)', options: ['x⁷', 'x¹²', 'x', 'x⁻¹'], correct: 0, explanation: 'Multiply same base: add exponents. x³⁺⁴ = x⁷.' },
  { id: 83, domain: 'D2', difficulty: 'Medium', question: 'Which value of x satisfies 2^x = 32?', options: ['4', '6', '3', '5'], correct: 3, explanation: '2⁵ = 32. x = 5.' },
  { id: 84, domain: 'D2', difficulty: 'Hard', question: 'y varies directly with x. y=12 when x=4. Find y when x=7.', options: ['18', '28', '21', '24'], correct: 2, explanation: 'k = y/x = 12/4 = 3. y = 3(7) = 21.' },
  { id: 85, domain: 'D3', difficulty: 'Easy', question: 'What is 40% of 85?', options: ['34', '42', '30', '38'], correct: 0, explanation: '0.40 × 85 = 34.' },
  { id: 86, domain: 'D3', difficulty: 'Easy', question: 'Ratio of 3:5. If total is 40, larger part = ?', options: ['15', '20', '25', '30'], correct: 2, explanation: '5/(3+5) × 40 = 5/8 × 40 = 25.' },
  { id: 87, domain: 'D3', difficulty: 'Medium', question: 'Rate: 240 miles in 4 hours. Speed in mph?', options: ['70', '50', '80', '60'], correct: 3, explanation: '240 ÷ 4 = 60 mph.' },
  { id: 88, domain: 'D3', difficulty: 'Medium', question: 'Original price $80, 25% off. Sale price?', options: ['$55', '$65', '$60', '$70'], correct: 2, explanation: '80 × 0.75 = $60.' },
  { id: 89, domain: 'D3', difficulty: 'Hard', question: 'Train A: 60mph, Train B: 80mph, same direction, A starts 1hr early. When does B catch A?', options: ['3 hrs', '4 hrs', '5 hrs', '2 hrs'], correct: 0, explanation: 'A's head start = 60mi. Closing rate = 80−60 = 20mph. 60/20 = 3 hours for B.' },
  { id: 90, domain: 'D4', difficulty: 'Easy', question: 'Right triangle legs: 5 and 12. Hypotenuse?', options: ['15', '17', '13', '11'], correct: 2, explanation: '√(25+144) = √169 = 13.' },
  { id: 91, domain: 'D4', difficulty: 'Medium', question: 'Area of trapezoid with bases 6 and 10, height 4?', options: ['32', '24', '16', '40'], correct: 0, explanation: 'A = ½(6+10)(4) = ½(16)(4) = 32.' },
  { id: 92, domain: 'D4', difficulty: 'Medium', question: 'Circle r=4. Area?', options: ['8π', '4π', '16π', '12π'], correct: 2, explanation: 'A = πr² = π(16) = 16π.' },
  { id: 93, domain: 'D1', difficulty: 'Easy', question: 'Simplify: 3x + 4x − 2x', options: ['9x', '4x', '6x', '5x'], correct: 3, explanation: '(3+4−2)x = 5x.' },
  { id: 94, domain: 'D1', difficulty: 'Medium', question: 'Solve: |x − 3| = 7', options: ['x=10 or x=−4', 'x=10 only', 'x=−4 only', 'x=4 or x=−10'], correct: 0, explanation: 'x−3=7→x=10 or x−3=−7→x=−4.' },
  { id: 95, domain: 'D2', difficulty: 'Hard', question: 'Log₂(64) = ?', options: ['8', '4', '32', '6'], correct: 3, explanation: '2⁶ = 64, so log₂(64) = 6.' },
  { id: 96, domain: 'D1', difficulty: 'Easy', question: 'Which is greater: 2/3 or 3/5?', options: ['3/5', '2/3', 'They are equal', 'Cannot determine'], correct: 1, explanation: '2/3 = 0.667, 3/5 = 0.600. 2/3 is greater.' },
  { id: 97, domain: 'D3', difficulty: 'Easy', question: 'On a number line, what is the distance between −4 and 6?', options: ['2', '10', '4', '8'], correct: 1, explanation: '|6 − (−4)| = |10| = 10.' },
  { id: 98, domain: 'D2', difficulty: 'Medium', question: '(2x²)³ simplified?', options: ['6x⁵', '8x⁶', '6x⁶', '2x⁶'], correct: 1, explanation: '2³ × x²ˣ³ = 8x⁶.' },
  { id: 99, domain: 'D4', difficulty: 'Hard', question: 'Two similar rectangles: ratio 2:3. If small has area 20, large has area?', options: ['30', '40', '45', '60'], correct: 2, explanation: 'Area ratio = 2²:3² = 4:9. Large area = 20 × (9/4) = 45.' },
  { id: 100, domain: 'D1', difficulty: 'Hard', question: 'Solve: 3/(x−1) = 6/(x+2)', options: ['x=8', 'x=4', 'x=−8', 'x=5'], correct: 1, explanation: 'Cross-multiply: 3(x+2)=6(x−1) → 3x+6=6x−6 → 3x=12 → x=4.' },
];
