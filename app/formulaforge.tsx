...
// ── D4 GEOMETRY & TRIG ────────────────────────────────────────────────────
  ...
  { id: 71, domain: 'D1', difficulty: 'Easy', question: 'Which correctly shows the formula for percent change?', options: ['(new - old) / new × 100', '(old - new) / old × 100', '(new - old) / old × 100', 'new / old × 100'], correct: 2, explanation: 'Percent change = [(new - old) / old] × 100. Option A divides by new (wrong denominator).' },
  { id: 72, domain: 'D1', difficulty: 'Easy', question: 'The formula for simple interest is:', options: ['I = Prt²', 'I = P(1+r)^t', 'I = Prt', 'I = P + rt'], correct: 2, explanation: 'Simple interest: I = Prt where P=principal, r=annual rate, t=time in years.' },
  { id: 73, domain: 'D3', difficulty: 'Easy', question: 'Which formula gives the mean of a data set?', options: ['sum / count', 'middle value', 'most frequent value', '(max + min) / 2'], correct: 0, explanation: 'Mean = sum of all values divided by count of values.' },
  { id: 74, domain: 'D1', difficulty: 'Medium', question: 'For the equation ax² + bx + c = 0, the sum of the roots equals:', options: ['c/a', '-c/a', 'b/a', '-b/a'], correct: 3, explanation: 'By Vieta's formulas, sum of roots = -b/a. Product of roots = c/a.' },
  { id: 75, domain: 'D2', difficulty: 'Medium', question: 'Which correctly expresses the difference of squares?', options: ['a² + b² = (a+b)(a-b)', 'a² - b² = (a-b)²', 'a² - b² = (a+b)(a-b)', 'a² - b² = (a-b)(a-b)'], correct: 2, explanation: 'Difference of squares: a² - b² = (a+b)(a-b). This is a key factoring identity.' },
  { id: 76, domain: 'D2', difficulty: 'Medium', question: 'Which formula correctly gives the nth term of an arithmetic sequence?', options: ['aₙ = a₁ × r^(n-1)', 'aₙ = a₁ + (n-1)d', 'aₙ = a₁ + nd', 'aₙ = a₁ × n'], correct: 1, explanation: 'Arithmetic: aₙ = a₁ + (n-1)d. Geometric uses r^(n-1). Start counting from n=1.' },
  { id: 77, domain: 'D2', difficulty: 'Hard', question: 'Which is the correct change of base formula for logarithms?', options: ['log_b(x) = log(b) / log(x)', 'log_b(x) = log(x) × log(b)', 'log_b(x) = log(x) / log(b)', 'log_b(x) = log(x) - log(b)'], correct: 2, explanation: 'Change of base: log_b(x) = log(x)/log(b). Works with any base (log₁₀ or ln).' },
  { id: 78, domain: 'D1', difficulty: 'Hard', question: 'Complete the square: x² + 6x + __ = (x + __)²', options: ['3; 3', '9; 3', '6; 6', '36; 6'], correct: 1, explanation: 'Add (b/2)² = (6/2)² = 9. So x² + 6x + 9 = (x+3)².' },
  { id: 79, domain: 'D4', difficulty: 'Medium', question: 'Which is the formula for the area of a regular hexagon with side s?', options: ['A = 3s²', 'A = (3√3/2)s²', 'A = 6s', 'A = 2√3 s²'], correct: 1, explanation: 'Regular hexagon area = (3√3/2)s². It consists of 6 equilateral triangles each with area (√3/4)s².' },
  { id: 80, domain: 'D3', difficulty: 'Easy', question: 'P(A or B) when A and B are mutually exclusive:', options: ['P(A) × P(B)', 'P(A) + P(B) - P(A and B)', 'P(A) + P(B)', 'P(A) / P(B)'], correct: 2, explanation: 'Mutually exclusive events can't both occur, so P(A and B)=0. P(A or B) = P(A) + P(B).' },
  { id: 81, domain: 'D2', difficulty: 'Hard', question: 'Which correctly gives the formula for n factorial (n!)?', options: ['n! = 1 × 2 × ... × n', 'n! = n × (n+1)', 'n! = n²', 'n! = 2^n'], correct: 0, explanation: 'n! = product of all positive integers from 1 to n. e.g. 5! = 1×2×3×4×5 = 120.' },
  { id: 82, domain: 'D1', difficulty: 'Medium', question: 'Which formula gives the x-intercepts of a parabola y = a(x-h)² + k?', options: ['x = h ± √(-k/a)', 'x = h ± √(k/a)', 'x = -h ± √(k/a)', 'x = ±√(k/a)'], correct: 0, explanation: 'Set y=0: a(x-h)² = -k → (x-h)² = -k/a → x = h ± √(-k/a). Requires -k/a ≥ 0 for real roots.' },
  { id: 83, domain: 'D3', difficulty: 'Medium', question: 'Which formula gives conditional probability P(A|B)?', options: ['P(A) × P(B)', 'P(A and B) / P(A)', 'P(A and B) / P(B)', 'P(A) / P(B)'], correct: 2, explanation: 'P(A|B) = P(A and B) / P(B). The probability of A given B has occurred.' },
  { id: 84, domain: 'D2', difficulty: 'Hard', question: 'Which correctly states the Pythagorean theorem in terms of trig?', options: ['sin²θ - cos²θ = 1', 'sin²θ + cos²θ = 1', 'tan²θ + 1 = sec²θ', 'Both B and C are correct'], correct: 3, explanation: 'sin²θ + cos²θ = 1 is the fundamental identity. Dividing by cos²θ gives tan²θ + 1 = sec²θ. Both are valid Pythagorean identities.' },
  { id: 85, domain: 'D1', difficulty: 'Easy', question: 'Standard form of a quadratic is:', options: ['y = a(x-h)² + k', 'y = mx + b', 'y = ax² + bx + c', 'y = a(x-r)(x-s)'], correct: 2, explanation: 'Standard form: y = ax² + bx + c. Vertex form is a(x-h)²+k. Factored form is a(x-r)(x-s).' },
  { id: 86, domain: 'D4', difficulty: 'Easy', question: 'Volume of a rectangular pyramid is:', options: ['lwh', '(1/2)lwh', '(1/3)lwh', '2lwh'], correct: 2, explanation: 'Volume of any pyramid = (1/3) × Base Area × height = (1/3)lwh.' },
  { id: 87, domain: 'D2', difficulty: 'Medium', question: 'Which gives the sum of interior angles of an n-sided polygon?', options: ['180(n)', '180(n-1)', '360', '180(n-2)'], correct: 3, explanation: '(n-2) × 180°. A triangle (n=3) has 180°. A quadrilateral (n=4) has 360°. etc.' },
  { id: 88, domain: 'D3', difficulty: 'Hard', question: 'The z-score formula is:', options: ['z = (x + μ) / σ', 'z = (x - μ) / σ', 'z = σ / (x - μ)', 'z = (μ - x) × σ'], correct: 1, explanation: 'z = (x - μ) / σ. It measures how many standard deviations x is from the mean μ.' },
  { id: 89, domain: 'D1', difficulty: 'Hard', question: 'Which is the correct formula for the distance from point (x₁,y₁) to a line Ax + By + C = 0?', options: ['d = |Ax₁ + By₁ + C|', 'd = (Ax₁ + By₁ + C) / (A+B)', 'd = |Ax₁ + By₁ + C| / √(A²+B²)', 'd = √(A²+B²)'], correct: 2, explanation: 'Distance from point to line: d = |Ax₁+By₁+C| / √(A²+B²). The denominator normalizes by the line's direction vector.' },
  { id: 90, domain: 'D2', difficulty: 'Medium', question: 'Which formula gives the nth term of a geometric sequence?', options: ['aₙ = a₁ + (n-1)r', 'aₙ = a₁ × r^n', 'aₙ = a₁ × r^(n-1)', 'aₙ = a₁ / r^(n-1)'], correct: 2, explanation: 'Geometric: aₙ = a₁ × r^(n-1). When n=1, a₁ × r⁰ = a₁. Arithmetic uses + not ×.' },

  { id: 91, domain: 'D1', difficulty: 'Easy', question: 'Which correctly gives the slope of a perpendicular line to y=4x+1?', options: ['4', '-4', '-1/4', '1/4'], correct: 2, explanation: 'Perpendicular slope = negative reciprocal. Slope of 4 -> perpendicular slope = -1/4.' },
  { id: 92, domain: 'D2', difficulty: 'Medium', question: 'Which formula gives log(A x B)?', options: ['log(A) x log(B)', 'log(A) - log(B)', 'log(A) + log(B)', 'log(A/B)'], correct: 2, explanation: 'Log product rule: log(AB) = log(A) + log(B).' },
  { id: 93, domain: 'D2', difficulty: 'Medium', question: 'Which formula gives log(A/B)?', options: ['log(A) + log(B)', 'log(A) - log(B)', 'log(A) x log(B)', 'log(A) / log(B)'], correct: 1, explanation: 'Log quotient rule: log(A/B) = log(A) - log(B).' },
  { id: 94, domain: 'D2', difficulty: 'Hard', question: 'Which formula gives log(A^n)?', options: ['n + log(A)', 'log(n) x log(A)', 'n x log(A)', 'log(A) ^ n'], correct: 2, explanation: 'Log power rule: log(A^n) = n x log(A).' },
  { id: 95, domain: 'D4', difficulty: 'Medium', question: 'Which correctly gives the area of an equilateral triangle with side s?', options: ['s^2 / 2', '(sqrt(3)/4)s^2', '(sqrt(2)/4)s^2', 's^2'], correct: 1, explanation: 'Equilateral triangle area = (sqrt(3)/4)s^2. Each equilateral triangle has height = (sqrt(3)/2)s.' },
  { id: 96, domain: 'D1', difficulty: 'Hard', question: 'If f(x) = 2x+3, which is f(f(x))?', options: ['4x+9', '4x+6', '4x+3', '2x+9'], correct: 0, explanation: 'f(f(x)) = f(2x+3) = 2(2x+3)+3 = 4x+6+3 = 4x+9.' },
  { id: 97, domain: 'D2', difficulty: 'Hard', question: 'i^2 = ? (imaginary numbers)', options: ['1', '2', '-1', 'i'], correct: 2, explanation: 'By definition, i = sqrt(-1), so i^2 = -1. This is the foundation of complex numbers.' },
  { id: 98, domain: 'D3', difficulty: 'Easy', question: 'Which formula gives P(A and B) for independent events?', options: ['P(A) + P(B)', 'P(A) - P(B)', 'P(A) / P(B)', 'P(A) x P(B)'], correct: 3, explanation: 'Independent events: P(A and B) = P(A) x P(B). They do not affect each other.' },
  { id: 99, domain: 'D4', difficulty: 'Medium', question: 'Which gives the number of diagonals in an n-sided polygon?', options: ['n(n-1)/2', 'n(n-3)/2', 'n(n-2)', 'n-3'], correct: 1, explanation: 'Diagonals = n(n-3)/2. A square (n=4): 4(1)/2 = 2 diagonals. Pentagon (n=5): 5(2)/2 = 5.' },
  { id: 100, domain: 'D2', difficulty: 'Hard', question: 'Which is the binomial expansion of (a+b)^2?', options: ['a^2 + b^2', 'a^2 + ab + b^2', 'a^2 + 2ab + b^2', '2a^2 + 2b^2'], correct: 2, explanation: '(a+b)^2 = a^2 + 2ab + b^2. The middle term 2ab is commonly forgotten.' },
];
