...
const QUESTIONS = [
  ...
  { id: 52, domain: 'D4', difficulty: 'Easy', instruction: 'Tap the redundant or unnecessary word', sentence: 'The future plans for the company look very promising.', words: ['The', 'future', 'plans', 'for', 'the', 'company', 'look', 'very', 'promising.'], errorIndex: 1, explanation: '"Plans" are inherently about the future. "Future" is redundant here.' },
  { id: 53, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'She gave a brief summary of the main points of the report.', words: ['She', 'gave', 'a', 'brief', 'summary', 'of', 'the', 'main', 'points', 'of', 'the', 'report.'], errorIndex: 3, explanation: 'A summary is by definition brief. "Brief" is redundant.' },
  { id: 54, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'They collaborated together on the project for six months.', words: ['They', 'collaborated', 'together', 'on', 'the', 'project', 'for', 'six', 'months.'], errorIndex: 2, explanation: '"Collaborate" means to work together. "Together" is redundant.' },
  { id: 55, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'He repeated the same mistake twice in one game.', words: ['He', 'repeated', 'the', 'same', 'mistake', 'twice', 'in', 'one', 'game.'], errorIndex: 3, explanation: '"Repeated" already implies doing something again. "Same" is redundant.' },
  ...
  { id: 62, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'Her past history of achievement made her an ideal candidate for the position.', words: ['Her', 'past', 'history', 'of', 'achievement', 'made', 'her', 'an', 'ideal', 'candidate', 'for', 'the', 'position.'], errorIndex: 1, explanation: '"History" refers to the past by definition. "Past" is redundant.' },
  { id: 63, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The unexpected surprise caught everyone in the office completely off guard.', words: ['The', 'unexpected', 'surprise', 'caught', 'everyone', 'in', 'the', 'office', 'completely', 'off', 'guard.'], errorIndex: 1, explanation: 'A surprise is by definition unexpected. "Unexpected" is redundant.' },
  { id: 64, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'We should try to avoid making the same identical mistake twice.', words: ['We', 'should', 'try', 'to', 'avoid', 'making', 'the', 'same', 'identical', 'mistake', 'twice.'], errorIndex: 8, explanation: '"Same" and "identical" mean the same thing. "Identical" is redundant.' },
  { id: 65, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'Please RSVP to the invitation by Friday afternoon at the latest.', words: ['Please', 'RSVP', 'to', 'the', 'invitation', 'by', 'Friday', 'afternoon', 'at', 'the', 'latest.'], errorIndex: 2, explanation: 'RSVP stands for "Répondez s'il vous plaît" (please respond). "Please RSVP" = "Please please respond." Drop "Please" or "to."' },
  { id: 66, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The CEO made her first inaugural speech to shareholders last Tuesday.', words: ['The', 'CEO', 'made', 'her', 'first', 'inaugural', 'speech', 'to', 'shareholders', 'last', 'Tuesday.'], errorIndex: 4, explanation: '"Inaugural" means first. "First inaugural" is redundant.' },
  { id: 67, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The two countries agreed to merge together their space programs.', words: ['The', 'two', 'countries', 'agreed', 'to', 'merge', 'together', 'their', 'space', 'programs.'], errorIndex: 6, explanation: '"Merge" already means to come together. "Together" is redundant.' },
  { id: 68, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'She wrote her memoir about the past memories of her childhood in Havana.', words: ['She', 'wrote', 'her', 'memoir', 'about', 'the', 'past', 'memories', 'of', 'her', 'childhood', 'in', 'Havana.'], errorIndex: 6, explanation: 'Memories are always from the past. "Past" is redundant before "memories."' },
  { id: 69, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'The reason for the delay was because the shipment arrived late.', words: ['The', 'reason', 'for', 'the', 'delay', 'was', 'because', 'the', 'shipment', 'arrived', 'late.'], errorIndex: 6, explanation: '"The reason was because" is redundant. Correct: "The reason was that..." or "It was late because..."' },
  { id: 70, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The scientist was able to successfully clone an exact replica of the original sample.', words: ['The', 'scientist', 'was', 'able', 'to', 'successfully', 'clone', 'an', 'exact', 'replica', 'of', 'the', 'original', 'sample.'], errorIndex: 8, explanation: 'A "replica" is already an exact copy. "Exact" is redundant.' },

  { id: 71, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The end product of the manufacturing process exceeded all quality benchmarks.', words: ['The', 'end', 'product', 'of', 'the', 'manufacturing', 'process', 'exceeded', 'all', 'quality', 'benchmarks.'], errorIndex: 1, explanation: '"Product" is already the result/end of a process. "End" is redundant.' },
  { id: 72, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'The reason why she left early was because she had an appointment.', words: ['The', 'reason', 'why', 'she', 'left', 'early', 'was', 'because', 'she', 'had', 'an', 'appointment.'], errorIndex: 7, explanation: '"The reason was because" is redundant. Correct: "The reason was that she had an appointment."' },
  { id: 73, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The consensus of opinion among the experts was that more testing was needed.', words: ['The', 'consensus', 'of', 'opinion', 'among', 'the', 'experts', 'was', 'that', 'more', 'testing', 'was', 'needed.'], errorIndex: 3, explanation: '"Consensus" already means a general agreement of opinion. "Of opinion" is redundant.' },
  { id: 74, domain: 'D4', difficulty: 'Easy', instruction: 'Tap the redundant or unnecessary word', sentence: 'Please advance forward to the next available window.', words: ['Please', 'advance', 'forward', 'to', 'the', 'next', 'available', 'window.'], errorIndex: 2, explanation: '"Advance" means to move forward. "Forward" is redundant.' },
  { id: 75, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'The close proximity of the two cities makes commuting practical.', words: ['The', 'close', 'proximity', 'of', 'the', 'two', 'cities', 'makes', 'commuting', 'practical.'], errorIndex: 1, explanation: '"Proximity" already means closeness/nearness. "Close" is redundant.' },
  { id: 76, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'We need to act now in order to prevent a future crisis from occurring.', words: ['We', 'need', 'to', 'act', 'now', 'in', 'order', 'to', 'prevent', 'a', 'future', 'crisis', 'from', 'occurring.'], errorIndex: 5, explanation: '"In order to" can be simplified to just "to." "In order" adds no meaning.' },
  { id: 77, domain: 'D4', difficulty: 'Easy', instruction: 'Tap the redundant or unnecessary word', sentence: 'She repeated the instructions again to make sure everyone understood.', words: ['She', 'repeated', 'the', 'instructions', 'again', 'to', 'make', 'sure', 'everyone', 'understood.'], errorIndex: 4, explanation: '"Repeated" already means said again. "Again" is redundant.' },
  { id: 78, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The biography was written by the author herself personally.', words: ['The', 'biography', 'was', 'written', 'by', 'the', 'author', 'herself', 'personally.'], errorIndex: 8, explanation: '"Herself" already emphasizes personal involvement. "Personally" is redundant.' },
  { id: 79, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'He gave a brief and concise explanation of the procedure.', words: ['He', 'gave', 'a', 'brief', 'and', 'concise', 'explanation', 'of', 'the', 'procedure.'], errorIndex: 3, explanation: '"Brief" and "concise" are synonymous. Using both is redundant -- remove one.' },
  { id: 80, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'She was asked to summarize the report briefly in a few sentences.', words: ['She', 'was', 'asked', 'to', 'summarize', 'the', 'report', 'briefly', 'in', 'a', 'few', 'sentences.'], errorIndex: 7, explanation: '"Summarize" already implies brevity. "Briefly" is redundant with "summarize."' },
  { id: 81, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'His ultimate goal was to eventually retire to a quiet coastal town.', words: ['His', 'ultimate', 'goal', 'was', 'to', 'eventually', 'retire', 'to', 'a', 'quiet', 'coastal', 'town.'], errorIndex: 5, explanation: '"Eventually" is implied by "goal" -- goals are future-oriented. Remove "eventually."' },
  { id: 82, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The witness was asked to describe the events in chronological order of time.', words: ['The', 'witness', 'was', 'asked', 'to', 'describe', 'the', 'events', 'in', 'chronological', 'order', 'of', 'time.'], errorIndex: 12, explanation: '"Chronological" already means arranged in order of time. "Of time" is redundant.' },
  { id: 83, domain: 'D4', difficulty: 'Easy', instruction: 'Tap the redundant or unnecessary word', sentence: 'Please attach together the two documents before submitting.', words: ['Please', 'attach', 'together', 'the', 'two', 'documents', 'before', 'submitting.'], errorIndex: 2, explanation: '"Attach" means to join or fasten -- "together" adds no new meaning.' },
  { id: 84, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The new innovation in battery technology could revolutionize electric vehicles.', words: ['The', 'new', 'innovation', 'in', 'battery', 'technology', 'could', 'revolutionize', 'electric', 'vehicles.'], errorIndex: 1, explanation: '"Innovation" by definition means something new. "New" is redundant.' },
  { id: 85, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'They decided to cancel the project and not proceed with it.', words: ['They', 'decided', 'to', 'cancel', 'the', 'project', 'and', 'not', 'proceed', 'with', 'it.'], errorIndex: 7, explanation: '"Cancel" means to decide not to proceed. "And not proceed with it" is redundant.' },

  { id: 86, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The new recruit was still an inexperienced novice.', words: ['The','new','recruit','was','still','an','inexperienced','novice.'], errorIndex: 6, explanation: '"Novice" by definition means inexperienced. "Inexperienced" is redundant.' },
  { id: 87, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'He circled around the block three times before finding a parking space.', words: ['He','circled','around','the','block','three','times','before','finding','a','parking','space.'], errorIndex: 2, explanation: '"Circle" already implies going around. "Around" is redundant.' },
  { id: 88, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The two coworkers collaborated together on the research paper.', words: ['The','two','coworkers','collaborated','together','on','the','research','paper.'], errorIndex: 4, explanation: '"Collaborate" means to work together. "Together" is redundant.' },
  { id: 89, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'They gathered together in the town square to protest the new law.', words: ['They','gathered','together','in','the','town','square','to','protest','the','new','law.'], errorIndex: 2, explanation: '"Gather" means to come together. "Together" adds nothing.' },
  { id: 90, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The committee will meet at 9 a.m. in the morning to review the findings.', words: ['The','committee','will','meet','at','9','a.m.','in','the','morning','to','review','the','findings.'], errorIndex: 7, explanation: '"a.m." already means morning (ante meridiem). "In the morning" is redundant.' },
  { id: 91, domain: 'D4', difficulty: 'Easy', instruction: 'Tap the redundant or unnecessary word', sentence: 'She nodded her head in agreement when she heard the news.', words: ['She','nodded','her','head','in','agreement','when','she','heard','the','news.'], errorIndex: 2, explanation: '"Nod" specifically refers to moving the head. "Her head" is redundant.' },
  { id: 92, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'The two options are both equally valid choices for this situation.', words: ['The','two','options','are','both','equally','valid','choices','for','this','situation.'], errorIndex: 5, explanation: '"Equally" is redundant with "both." "Both are valid" or "equally valid" -- not both together.' },
  { id: 93, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'The armed gunman entered the building through the back entrance.', words: ['The','armed','gunman','entered','the','building','through','the','back','entrance.'], errorIndex: 1, explanation: 'A "gunman" is by definition armed. "Armed" is redundant.' },
  { id: 94, domain: 'D4', difficulty: 'Hard', instruction: 'Tap the redundant or unnecessary word', sentence: 'Each individual student is required to submit a separate form.', words: ['Each','individual','student','is','required','to','submit','a','separate','form.'], errorIndex: 1, explanation: '"Each" already refers to individuals one by one. "Individual" is redundant.' },
  { id: 95, domain: 'D4', difficulty: 'Medium', instruction: 'Tap the redundant or unnecessary word', sentence: 'The cash money raised at the event will go to local charities.', words: ['The','cash','money','raised','at','the','event','will','go','to','local','charities.'], errorIndex: 1, explanation: '"Cash" is a form of money. "Cash money" is redundant.' },
];
