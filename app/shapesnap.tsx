...
const QUESTIONS = [
  // ── EASY: Basic formulas ──────────────────────────────────────────────────
  { id: 1, domain: 'D4', difficulty: 'Easy', formula: 'A = πr²', question: 'A circle has a radius of 5. What is its area?', options: ['25π', '10π', '5π', '20π'], correct: 0, explanation: 'Area of circle = πr² = π(5)² = 25π' },
  { id: 2, domain: 'D4', difficulty: 'Easy', formula: 'a² + b² = c²', question: 'A right triangle has legs of length 3 and 4. What is the hypotenuse?', options: ['5', '6', '7', '√7'], correct: 0, explanation: 'Pythagorean theorem: 3² + 4² = 9 + 16 = 25, so c = √25 = 5' },
  { id: 3, domain: 'D4', difficulty: 'Easy', formula: 'C = 2πr', question: 'A circle has a radius of 6. What is its circumference?', options: ['12π', '36π', '6π', '18π'], correct: 0, explanation: 'Circumference = 2πr = 2π(6) = 12π' },
  { id: 4, domain: 'D4', difficulty: 'Easy', formula: 'A = ½bh', question: 'A triangle has a base of 8 and height of 5. What is its area?', options: ['20', '40', '13', '16'], correct: 0, explanation: 'Area = ½bh = ½(8)(5) = 20' },
  { id: 5, domain: 'D4', difficulty: 'Easy', formula: 'Interior angles sum = (n-2)×180°', question: 'What is the sum of the interior angles of a hexagon?', options: ['720°', '540°', '900°', '360°'], correct: 0, explanation: 'Sum = (n-2)×180 = (6-2)×180 = 4×180 = 720°' },
  { id: 6, domain: 'D4', difficulty: 'Easy', formula: 'V = πr²h', question: 'A cylinder has radius 3 and height 4. What is its volume?', options: ['36π', '12π', '48π', '24π'], correct: 0, explanation: 'V = πr²h = π(3)²(4) = 9π(4) = 36π' },
  { id: 7, domain: 'D4', difficulty: 'Easy', formula: 'A = s²', question: 'A square has a side length of 7. What is its area?', options: ['49', '28', '14', '56'], correct: 0, explanation: 'Area of square = s² = 7² = 49' },
  { id: 8, domain: 'D4', difficulty: 'Easy', formula: 'sin θ = opp/hyp', question: 'In a right triangle, the opposite side is 3 and the hypotenuse is 5. What is sin θ?', options: ['3/5', '4/5', '3/4', '5/3'], correct: 0, explanation: 'sin θ = opposite/hypotenuse = 3/5' },
  { id: 9, domain: 'D4', difficulty: 'Easy', formula: 'A = lw', question: 'A rectangle has length 9 and width 4. What is its area?', options: ['36', '26', '13', '72'], correct: 0, explanation: 'Area = length × width = 9 × 4 = 36' },
  { id: 10, domain: 'D4', difficulty: 'Easy', formula: 'Exterior angle = 360°/n', question: 'What is the measure of each exterior angle of a regular pentagon?', options: ['72°', '60°', '90°', '108°'], correct: 0, explanation: 'Exterior angle = 360°/n = 360°/5 = 72°' },
  { id: 11, domain: 'D4', difficulty: 'Easy', formula: 'V = (4/3)πr³', question: 'A sphere has a radius of 3. What is its volume?', options: ['36π', '12π', '27π', '108π'], correct: 0, explanation: 'V = (4/3)πr³ = (4/3)π(3)³ = (4/3)(27π) = 36π' },
  { id: 12, domain: 'D4', difficulty: 'Easy', formula: 'cos θ = adj/hyp', question: 'In a right triangle, the adjacent side is 4 and the hypotenuse is 5. What is cos θ?', options: ['4/5', '3/5', '4/3', '5/4'], correct: 0, explanation: 'cos θ = adjacent/hypotenuse = 4/5' },
  { id: 13, domain: 'D4', difficulty: 'Easy', formula: 'P = 2l + 2w', question: 'A rectangle has length 10 and width 4. What is its perimeter?', options: ['28', '40', '14', '24'], correct: 0, explanation: 'Perimeter = 2l + 2w = 2(10) + 2(4) = 20 + 8 = 28' },
  { id: 14, domain: 'D4', difficulty: 'Easy', formula: '30-60-90: sides x, x√3, 2x', question: 'In a 30-60-90 triangle, the shortest side is 4. What is the hypotenuse?', options: ['8', '4√3', '4√2', '6'], correct: 0, explanation: 'In a 30-60-90 triangle, hypotenuse = 2 × shortest side = 2(4) = 8' },
  { id: 15, domain: 'D4', difficulty: 'Easy', formula: '45-45-90: sides x, x, x√2', question: 'In a 45-45-90 triangle, each leg has length 5. What is the hypotenuse?', options: ['5√2', '10', '5√3', '25'], correct: 0, explanation: 'In a 45-45-90 triangle, hypotenuse = leg × √2 = 5√2' },
  { id: 16, domain: 'D4', difficulty: 'Easy', formula: 'tan θ = opp/adj', question: 'In a right triangle, the opposite side is 3 and the adjacent side is 3. What is tan θ?', options: ['1', '√2', '√3', '1/√2'], correct: 0, explanation: 'tan θ = opposite/adjacent = 3/3 = 1, so θ = 45°' },
  { id: 17, domain: 'D4', difficulty: 'Easy', formula: 'A = πr²', question: 'A circle has a diameter of 10. What is its area?', options: ['25π', '100π', '50π', '10π'], correct: 0, explanation: 'Diameter = 10, so radius = 5. Area = πr² = π(5)² = 25π' },
  ...
  { id: 19, domain: 'D4', difficulty: 'Medium', formula: 'Sector area = (θ/360)×πr²', question: 'A circle has radius 6. What is the area of a 90° sector?', options: ['9π', '36π', '12π', '6π'], correct: 0, explanation: 'Sector area = (90/360) × π(6)² = (1/4)(36π) = 9π' },
  { id: 20, domain: 'D4', difficulty: 'Medium', formula: 'V = (1/3)πr²h', question: 'A cone has radius 3 and height 4. What is its volume?', options: ['12π', '36π', '9π', '16π'], correct: 0, explanation: 'V = (1/3)πr²h = (1/3)π(9)(4) = 12π' },
  { id: 21, domain: 'D4', difficulty: 'Medium', formula: 'd = √((x₂-x₁)² + (y₂-y₁)²)', question: 'What is the distance between points (1, 2) and (4, 6)?', options: ['5', '4', '√7', '6'], correct: 0, explanation: 'd = √((4-1)² + (6-2)²) = √(9+16) = √25 = 5' },
  ...
  { id: 23, domain: 'D4', difficulty: 'Medium', formula: 'SA = 2πr² + 2πrh', question: 'A cylinder has radius 2 and height 5. What is its total surface area?', options: ['28π', '20π', '14π', '24π'], correct: 0, explanation: 'SA = 2πr² + 2πrh = 2π(4) + 2π(2)(5) = 8π + 20π = 28π' },
  { id: 24, domain: 'D4', difficulty: 'Medium', formula: 'Interior angle = (n-2)×180/n', question: 'What is the measure of each interior angle of a regular octagon?', options: ['135°', '120°', '144°', '150°'], correct: 0, explanation: 'Interior angle = (8-2)×180/8 = 6×180/8 = 1080/8 = 135°' },
  { id: 25, domain: 'D4', difficulty: 'Medium', formula: 'a² + b² = c²', question: 'A ladder 13 feet long leans against a wall. The base is 5 feet from the wall. How high up the wall does it reach?', options: ['12', '8', '10', '11'], correct: 0, explanation: 'a² + 5² = 13², so a² = 169 - 25 = 144, a = 12 feet' },
  ...
  { id: 27, domain: 'D4', difficulty: 'Medium', formula: '30-60-90: sides x, x√3, 2x', question: 'In a 30-60-90 triangle, the hypotenuse is 10. What is the length of the side opposite 60°?', options: ['5√3', '5', '10√3', '5√2'], correct: 0, explanation: 'Hypotenuse = 2x = 10, so x = 5. Side opposite 60° = x√3 = 5√3' },
  { id: 28, domain: 'D4', difficulty: 'Medium', formula: 'A = ½d₁d₂', question: 'A rhombus has diagonals of length 8 and 6. What is its area?', options: ['24', '48', '12', '36'], correct: 0, explanation: 'Area of rhombus = ½d₁d₂ = ½(8)(6) = 24' },
  { id: 29, domain: 'D4', difficulty: 'Medium', formula: 'V = lwh', question: 'A rectangular prism has length 5, width 3, and height 4. What is its volume?', options: ['60', '47', '24', '120'], correct: 0, explanation: 'V = lwh = 5 × 3 × 4 = 60' },
  ...
  { id: 31, domain: 'D4', difficulty: 'Medium', formula: 'Arc length = (θ/360)×2πr', question: 'A sector has a central angle of 60° and radius 12. What is its arc length?', options: ['4π', '6π', '2π', '8π'], correct: 0, explanation: 'Arc length = (60/360) × 2π(12) = (1/6)(24π) = 4π' },
  { id: 32, domain: 'D4', difficulty: 'Medium', formula: 'd = √((x₂-x₁)² + (y₂-y₁)²)', question: 'What is the distance between points (-3, 1) and (3, 9)?', options: ['10', '8', '√52', '12'], correct: 0, explanation: 'd = √((3-(-3))² + (9-1)²) = √(36+64) = √100 = 10' },
  { id: 33, domain: 'D4', difficulty: 'Medium', formula: 'V = (1/3)Bh', question: 'A square pyramid has a base side of 6 and height 4. What is its volume?', options: ['48', '72', '24', '96'], correct: 0, explanation: 'V = (1/3)Bh = (1/3)(36)(4) = 48' },
  ...
  { id: 35, domain: 'D4', difficulty: 'Hard', formula: 'Sector area = (θ/360)×πr²', question: 'A circle has area 36π. A sector has central angle 120°. What is the sector area?', options: ['12π', '9π', '18π', '6π'], correct: 0, explanation: 'Circle area = 36π, so r² = 36. Sector = (120/360) × 36π = (1/3)(36π) = 12π' },
  { id: 36, domain: 'D4', difficulty: 'Hard', formula: 'a² = b² + c² - 2bc·cosA', question: 'A triangle has sides b = 5, c = 7, and angle A = 60°. What is the length of side a?', options: ['√39', '√49', '√25', '√61'], correct: 0, explanation: 'a² = 5² + 7² - 2(5)(7)cos60° = 25 + 49 - 70(0.5) = 74 - 35 = 39, so a = √39' },
  { id: 37, domain: 'D4', difficulty: 'Hard', formula: 'SA = πr² + πrl', question: 'A cone has radius 3 and slant height 5. What is its total surface area?', options: ['24π', '15π', '18π', '30π'], correct: 0, explanation: 'SA = πr² + πrl = π(9) + π(3)(5) = 9π + 15π = 24π' },
  ...
  { id: 39, domain: 'D4', difficulty: 'Hard', formula: 'Distance formula + midpoint', question: 'A circle has center (2, 3) and passes through (6, 6). What is its radius?', options: ['5', '4', '√34', '6'], correct: 0, explanation: 'r = distance from center to point = √((6-2)² + (6-3)²) = √(16+9) = √25 = 5' },
  { id: 40, domain: 'D4', difficulty: 'Hard', formula: 'V = (4/3)πr³', question: 'A sphere\'s volume is 288π. What is its radius?', options: ['6', '4', '8', '3'], correct: 0, explanation: '(4/3)πr³ = 288π, r³ = 288×(3/4) = 216, r = ∛216 = 6' },
  { id: 41, domain: 'D4', difficulty: 'Hard', formula: 'tan θ = opp/adj', question: 'A 10-foot flagpole casts a shadow. The angle of elevation to the top is 60°. How long is the shadow?', options: ['10√3/3', '10√3', '5√3', '10'], correct: 0, explanation: 'tan60° = 10/shadow, √3 = 10/shadow, shadow = 10/√3 = 10√3/3' },
  ...
  { id: 43, domain: 'D4', difficulty: 'Hard', formula: '30-60-90 + area', question: 'An equilateral triangle has side length 8. What is its area?', options: ['16√3', '32√3', '8√3', '64√3'], correct: 0, explanation: 'Height = 8×(√3/2) = 4√3. Area = ½ × base × height = ½ × 8 × 4√3 = 16√3' },
  { id: 44, domain: 'D4', difficulty: 'Hard', formula: 'SA = 2lw + 2lh + 2wh', question: 'A rectangular prism has length 4, width 3, height 5. What is its surface area?', options: ['94', '60', '47', '120'], correct: 0, explanation: 'SA = 2(4)(3) + 2(4)(5) + 2(3)(5) = 24 + 40 + 30 = 94' },
  { id: 45, domain: 'D4', difficulty: 'Hard', formula: 'cosine rule + area', question: 'In triangle ABC, a = 6, b = 8, C = 90°. What is the area of the triangle?', options: ['24', '48', '12', '36'], correct: 0, explanation: 'Since C = 90°, the legs are 6 and 8. Area = ½(6)(8) = 24' },
  ...
  { id: 47, domain: 'D4', difficulty: 'Hard', formula: 'sin A/a = sin B/b', question: 'In triangle ABC, angle B = 60°, b = 6√3, and a = 6. What is angle A?', options: ['30°', '45°', '60°', '90°'], correct: 0, explanation: 'sinA/6 = sin60°/(6√3) = (√3/2)/(6√3) = 1/12. sinA = 6/12 = 1/2, so A = 30°' },
  { id: 48, domain: 'D4', difficulty: 'Hard', formula: 'Sector + triangle area', question: 'A sector with radius 4 and central angle 90° is cut from a circle. What is the area of the remaining shape (the major sector)?', options: ['12π', '4π', '8π', '16π'], correct: 0, explanation: 'Full circle area = 16π. Minor sector area = (90/360)×16π = 4π. Major sector = 16π - 4π = 12π' },
  { id: 49, domain: 'D4', difficulty: 'Hard', formula: 'Heron\'s formula', question: 'A triangle has sides 5, 12, and 13. What is its area?', options: ['30', '60', '26', '65'], correct: 0, explanation: 'Since 5² + 12² = 25 + 144 = 169 = 13², this is a right triangle. Area = ½(5)(12) = 30' },
