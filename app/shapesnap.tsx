...
const QUESTIONS = [
  ...
  { id: 76, domain: 'D4', difficulty: 'Easy', formula: 'P = 2(l + w)', question: 'Rectangle: length 14, width 6. Perimeter?', options: ['84', '20', '40', '48'], correct: 2, explanation: 'P = 2(14+6) = 2(20) = 40.' },
  { id: 77, domain: 'D4', difficulty: 'Easy', formula: 'A = s^2', question: 'Square with perimeter 36. Area?', options: ['81', '36', '18', '72'], correct: 0, explanation: 'Side = 36/4 = 9. Area = 9^2 = 81.' },
  { id: 78, domain: 'D4', difficulty: 'Medium', formula: 'a^2 + b^2 = c^2', question: 'Right triangle legs: 7 and 24. Hypotenuse?', options: ['25', '31', '√527', '26'], correct: 0, explanation: '49 + 576 = 625. sqrt(625) = 25.' },
  { id: 79, domain: 'D4', difficulty: 'Medium', formula: 'Similar triangles', question: 'Triangle sides 5, 12, 13. Similar triangle has longest side 26. Shortest side?', options: ['8', '10', '24', '6'], correct: 1, explanation: 'Scale = 26/13 = 2. Shortest = 5 x 2 = 10.' },
  { id: 80, domain: 'D4', difficulty: 'Easy', formula: 'Angles on a line = 180', question: 'Two angles on a straight line: one is 65. Other is?', options: ['125', '115', '75', '95'], correct: 1, explanation: '180 - 65 = 115.' },
  { id: 81, domain: 'D4', difficulty: 'Medium', formula: 'V = lwh', question: 'Box has volume 360. Length 10, width 6. Height?', options: ['5', '8', '6', '4'], correct: 2, explanation: 'h = 360 / (10 x 6) = 360/60 = 6.' },
  { id: 82, domain: 'D4', difficulty: 'Hard', formula: 'Arc length = (theta/360) x 2pi r', question: 'Circle r=10, arc angle=72. Arc length?', options: ['2pi', '4pi', '72pi', '10pi'], correct: 1, explanation: '(72/360) x 2pi(10) = (1/5)(20pi) = 4pi.' },
  { id: 83, domain: 'D4', difficulty: 'Medium', formula: 'Exterior angle theorem', question: 'Triangle: two remote interior angles 55 and 70. Exterior angle?', options: ['55', '125', '110', '70'], correct: 1, explanation: 'Exterior angle = sum of remote interior angles = 55+70 = 125.' },
  { id: 84, domain: 'D4', difficulty: 'Hard', formula: 'SA = 6s^2 (cube)', question: 'Cube surface area = 96. Side length?', options: ['16', '6', '4', '8'], correct: 2, explanation: '6s^2=96, s^2=16, s=4.' },
  { id: 85, domain: 'D4', difficulty: 'Medium', formula: 'tan = opp/adj', question: 'Right triangle: opposite=9, adjacent=12. tan(theta)?', options: ['4/3', '3/5', '3/4', '5/3'], correct: 2, explanation: 'tan = 9/12 = 3/4.' },
  { id: 86, domain: 'D4', difficulty: 'Easy', formula: 'Vertical angles are equal', question: 'Two lines intersect. One angle is 42. Vertical angle is?', options: ['138', '48', '42', '96'], correct: 2, explanation: 'Vertical angles are always equal: 42.' },
  { id: 87, domain: 'D4', difficulty: 'Medium', formula: 'V = (1/3)pi r^2 h', question: 'Cone r=3, h=7. Volume?', options: ['21pi', '9pi', '63pi', '7pi'], correct: 0, explanation: 'V = (1/3)pi(9)(7) = 21pi.' },
  { id: 88, domain: 'D4', difficulty: 'Hard', formula: '45-45-90 triangle', question: '45-45-90 triangle. Hypotenuse=10. Leg length?', options: ['10', '5', '5*sqrt(3)', '5*sqrt(2)'], correct: 3, explanation: 'Leg = hyp / sqrt(2) = 10/sqrt(2) = 5*sqrt(2).' },
  { id: 89, domain: 'D4', difficulty: 'Medium', formula: 'Sector area = (theta/360)pi r^2', question: 'Circle r=6. Sector area=3pi. Central angle?', options: ['15', '30', '45', '60'], correct: 1, explanation: '3pi = (theta/360)pi(36), theta/360=3/36=1/12, theta=30.' },
  { id: 90, domain: 'D4', difficulty: 'Hard', formula: 'Inscribed angle = (1/2) central angle', question: 'Inscribed angle intercepts arc of 160. Inscribed angle =?', options: ['160', '320', '80', '40'], correct: 2, explanation: 'Inscribed angle = half the intercepted arc = 160/2 = 80.' },
  { id: 91, domain: 'D4', difficulty: 'Easy', formula: 'Interior angles of polygon', question: 'Regular octagon. Each interior angle?', options: ['120', '135', '150', '144'], correct: 1, explanation: '(8-2)x180/8 = 1080/8 = 135.' },
  { id: 92, domain: 'D4', difficulty: 'Medium', formula: 'Midpoint formula', question: 'Midpoint of (2,4) and (8,12)?', options: ['(5,8)', '(6,8)', '(5,7)', '(4,8)'], correct: 0, explanation: 'M = ((2+8)/2, (4+12)/2) = (5,8).' },
  { id: 93, domain: 'D4', difficulty: 'Hard', formula: 'Distance formula', question: 'Distance between (1,2) and (5,5)?', options: ['5', '4', '7', 'sqrt(7)'], correct: 0, explanation: 'd = sqrt((5-1)^2 + (5-2)^2) = sqrt(16+9) = sqrt(25) = 5.' },
  { id: 94, domain: 'D4', difficulty: 'Medium', formula: 'A = (1/2)d1*d2 (rhombus)', question: 'Rhombus diagonals 6 and 14. Area?', options: ['84', '20', '42', '21'], correct: 2, explanation: 'A = (1/2)(6)(14) = 42.' },
  { id: 95, domain: 'D4', difficulty: 'Hard', formula: 'Law of cosines', question: 'Triangle a=8, b=6, C=90. Find c.', options: ['10', '14', '100', 'sqrt(28)'], correct: 0, explanation: 'c^2 = 64+36-2(8)(6)cos90 = 100-0 = 100. c=10.' },
];
