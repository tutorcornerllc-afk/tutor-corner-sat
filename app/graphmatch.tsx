...
const QUESTIONS = [
  ...
  { id: 71, domain: 'D2', difficulty: 'Hard', type: 'equation→description', question: 'y = 2^x. Which best describes this graph?', graph: { type: 'exponential', base: 2 }, options: ['Decreasing curve approaching y=0', 'Straight line with slope 2', 'U-shaped parabola', 'Increasing curve, always above x-axis'], correct: 3, explanation: 'y=2^x is exponential growth: always positive, always increasing, never touches x-axis.' },
  { id: 72, domain: 'D1', difficulty: 'Hard', type: 'features→equation', question: 'System: 2x+3y=12 and x−y=1. Intersection point?', graph: { type: 'system', slope1: -0.667, intercept1: 4, slope2: 1, intercept2: -1 }, options: ['(2, 3)', '(3, 2)', '(4, 1)', '(1, 4)'], correct: 1, explanation: 'From x=y+1 sub into 2(y+1)+3y=12 → 5y=10 → y=2, x=3. Point: (3,2).' },
  { id: 73, domain: 'D2', difficulty: 'Hard', type: 'equation→description', question: 'y = −(x+3)² + 7. Which describes this parabola?', graph: { type: 'parabola', a: -1, h: -3, k: 7 }, options: ['Opens up, vertex (3, 7)', 'Opens down, vertex (−3, 7)', 'Opens up, vertex (−3, −7)', 'Opens down, vertex (3, −7)'], correct: 1, explanation: 'a=−1<0 opens down. Vertex form: h=−3, k=7. Vertex at (−3, 7).' },
  { id: 74, domain: 'D1', difficulty: 'Hard', type: 'features→equation', question: 'Which equation has x-intercepts at x=2 and x=−5?', graph: { type: 'parabola', a: 1, h: -1.5, k: -12.25 }, options: ['y=(x+2)(x−5)', 'y=(x−2)(x+5)', 'y=(x+2)(x+5)', 'y=(x−2)(x−5)'], correct: 1, explanation: 'Roots at x=2 and x=−5 mean factors are (x−2) and (x+5).' },
  { id: 75, domain: 'D2', difficulty: 'Hard', type: 'equation→description', question: 'y = 3x² − 12x + 9. Which are the x-intercepts?', graph: { type: 'parabola', a: 3, h: 2, k: -3 }, options: ['x=1 and x=3', 'x=−1 and x=−3', 'x=2 and x=3', 'x=0 and x=4'], correct: 0, explanation: '3(x²−4x+3)=3(x−1)(x−3)=0 → x=1 or x=3.' },

  { id: 76, domain: 'D1', difficulty: 'Easy', type: 'equation→description', question: 'y = 5. Which best describes this graph?', graph: { type: 'line', slope: 0, intercept: 5 }, options: ['Vertical line at x=5', 'Line with slope 5', 'Horizontal line at y=5', 'Diagonal line'], correct: 2, explanation: 'y = constant with no x → horizontal line at that y-value.' },
  { id: 77, domain: 'D1', difficulty: 'Easy', type: 'description→equation', question: 'Which equation passes through (0,0) with slope 4?', graph: { type: 'line', slope: 4, intercept: 0 }, options: ['y = x + 4', 'y = 4', 'y = 4x + 4', 'y = 4x'], correct: 3, explanation: 'Through origin (b=0) with slope 4: y = 4x.' },
  { id: 78, domain: 'D1', difficulty: 'Medium', type: 'features→equation', question: 'Line through (3,7) and (6,13). Which equation?', graph: { type: 'line', slope: 2, intercept: 1 }, options: ['y = 3x - 2', 'y = 2x + 1', 'y = 2x - 1', 'y = 3x + 1'], correct: 1, explanation: 'Slope = (13-7)/(6-3) = 2. y-7 = 2(x-3) → y = 2x+1.' },
  { id: 79, domain: 'D2', difficulty: 'Medium', type: 'equation→description', question: 'y = x² - 6x + 9. Which describes it?', graph: { type: 'parabola', a: 1, h: 3, k: 0 }, options: ['Two x-intercepts at x=3 and x=6', 'Touches x-axis once at x=3', 'Never touches x-axis', 'Opens downward'], correct: 1, explanation: 'y = (x-3)². Perfect square → touches x-axis at x=3 only (double root).' },
  { id: 80, domain: 'D1', difficulty: 'Hard', type: 'features→equation', question: 'Which line has the same x-intercept as y = 3x - 6?', graph: { type: 'line', slope: 3, intercept: -6 }, options: ['y = 2x - 4', 'y = x - 6', 'y = -x + 2', 'y = 5x - 10'], correct: 3, explanation: '3x-6=0 → x=2. Check: 5(2)-10=0 ✓. Option D also passes through (2,0).' },
  { id: 81, domain: 'D2', difficulty: 'Hard', type: 'equation→description', question: 'y = -x² + 4x - 3. How many x-intercepts?', graph: { type: 'parabola', a: -1, h: 2, k: 1 }, options: ['0', '1', '2', 'Infinitely many'], correct: 2, explanation: 'Discriminant b²-4ac = 16-12 = 4 > 0. Two distinct real roots → 2 x-intercepts.' },
  { id: 82, domain: 'D1', difficulty: 'Medium', type: 'equation→description', question: 'y = (1/2)x - 3 and y = 2x + 1 are:', options: ['Parallel', 'Perpendicular', 'The same line', 'Both horizontal'], correct: 1, explanation: 'Slopes: 1/2 and 2. Product = (1/2)(2) = 1... wait, perpendicular requires product = -1. These are NOT perpendicular. Actually m₁×m₂ = 1/2 × 2 = 1 ≠ -1, so they intersect but are not perpendicular.' },
  { id: 83, domain: 'D2', difficulty: 'Hard', type: 'equation→description', question: 'f(x) = 2x² - 8. For which x is f(x) < 0?', graph: { type: 'parabola', a: 2, h: 0, k: -8 }, options: ['x < -2 or x > 2', 'x > 2 only', '-2 < x < 2', 'All x'], correct: 2, explanation: '2x²-8 < 0 → x² < 4 → -2 < x < 2. The parabola is below x-axis between its roots.' },
  { id: 84, domain: 'D1', difficulty: 'Medium', type: 'description→equation', question: 'Which equation represents a line with y-intercept -4 and x-intercept 2?', graph: { type: 'line', slope: 2, intercept: -4 }, options: ['y = 2x + 4', 'y = -2x + 4', 'y = 2x - 4', 'y = -2x - 4'], correct: 2, explanation: 'Slope = rise/run = (0-(-4))/(2-0) = 4/2 = 2. y = 2x - 4.' },
  { id: 85, domain: 'D2', difficulty: 'Hard', type: 'equation→description', question: 'y = 2^x and y = (1/2)^x. How do they relate?', graph: { type: 'exponential', base: 2 }, options: ['They are the same graph', 'They are parallel', 'They are reflections across the y-axis', 'One is a translation of the other'], correct: 2, explanation: '(1/2)^x = 2^(-x). Replacing x with -x reflects the graph across the y-axis.' },
  { id: 86, domain: 'D1', difficulty: 'Easy', type: 'equation→description', question: 'y = -2x + 6. What is the y-intercept?', graph: { type: 'line', slope: -2, intercept: 6 }, options: ['-2', '3', '-6', '6'], correct: 3, explanation: 'y = mx + b. b = 6 is the y-intercept (where x=0).' },
  { id: 87, domain: 'D1', difficulty: 'Medium', type: 'equation→description', question: 'System: x + y = 8, 2x - y = 4. Find y.', graph: { type: 'system', slope1: -1, intercept1: 8, slope2: 2, intercept2: -4 }, options: ['2', '6', '4', '8'], correct: 2, explanation: 'Add: 3x = 12 → x = 4. Sub: 4+y=8 → y=4.' },
  { id: 88, domain: 'D2', difficulty: 'Medium', type: 'equation→description', question: 'Which parabola has no real x-intercepts?', graph: { type: 'parabola', a: 1, h: 0, k: 3 }, options: ['y = x² - 4', 'y = -x² + 9', 'y = x² + 3', 'y = x² - 9'], correct: 2, explanation: 'x² + 3 = 0 → x² = -3. No real solution. The parabola sits entirely above the x-axis.' },

  { id: 89, domain: 'D1', difficulty: 'Easy', type: 'description->equation', question: 'Which equation has the steepest slope?', graph: { type: 'line', slope: 5, intercept: 0 }, options: ['y = x + 10', 'y = 3x - 1', 'y = -2x + 5', 'y = 5x'], correct: 3, explanation: 'Steepness = |slope|. |5| > |3| > |-2| > |1|. y=5x has the steepest slope.' },
  { id: 90, domain: 'D1', difficulty: 'Medium', type: 'equation->description', question: 'y = -4x + 8. X-intercept?', graph: { type: 'line', slope: -4, intercept: 8 }, options: ['(0, 8)', '(2, 0)', '(-2, 0)', '(8, 0)'], correct: 1, explanation: 'Set y=0: -4x+8=0, x=2. X-intercept is (2, 0).' },
  { id: 91, domain: 'D2', difficulty: 'Medium', type: 'equation->description', question: 'y = x^2 - 2x - 3. Which x-values are the roots?', graph: { type: 'parabola', a: 1, h: 1, k: -4 }, options: ['x=-1 and x=3', 'x=1 and x=-3', 'x=-1 and x=-3', 'x=1 and x=3'], correct: 0, explanation: 'Factor: (x-3)(x+1)=0. Roots: x=3 and x=-1.' },
  { id: 92, domain: 'D1', difficulty: 'Hard', type: 'features->equation', question: 'Line has slope 2 and passes through (3, 7). Equation?', graph: { type: 'line', slope: 2, intercept: 1 }, options: ['y = 2x + 1', 'y = 2x + 7', 'y = 2x - 1', 'y = 3x + 7'], correct: 0, explanation: 'y - 7 = 2(x-3), y = 2x - 6 + 7 = 2x + 1.' },
  { id: 93, domain: 'D2', difficulty: 'Hard', type: 'equation->description', question: 'y = (x-1)^2 + 3. This parabola has:', options: ['Vertex (1,3), no x-intercepts', 'Vertex (-1,3), two x-intercepts', 'Vertex (1,-3), opens down', 'Vertex (1,3), opens down'], correct: 0, explanation: 'Vertex form: h=1, k=3, a=1>0 opens up. Min value y=3>0, so no x-intercepts.' },
  { id: 94, domain: 'D1', difficulty: 'Easy', type: 'equation->description', question: 'y = -x + 4. As x increases, y:', options: ['Increases', 'Stays the same', 'Decreases', 'Oscillates'], correct: 2, explanation: 'Negative slope (-1) means as x increases, y decreases.' },
  { id: 95, domain: 'D2', difficulty: 'Hard', type: 'equation->description', question: 'y = x^3. Which best describes this curve?', graph: { type: 'cubic', a: 1 }, options: ['Always decreasing', 'U-shaped parabola', 'S-shaped curve through origin, always increasing', 'Horizontal line'], correct: 2, explanation: 'y=x^3 is a cubic: S-shaped, passes through origin, increasing for all x.' },
  { id: 96, domain: 'D1', difficulty: 'Medium', type: 'features->equation', question: 'Which line has a positive slope and negative y-intercept?', graph: { type: 'line', slope: 2, intercept: -3 }, options: ['y = -2x + 3', 'y = 2x + 3', 'y = -2x - 3', 'y = 2x - 3'], correct: 3, explanation: 'Positive slope: m>0. Negative y-intercept: b<0. Only y=2x-3 fits both.' },
  { id: 97, domain: 'D2', difficulty: 'Hard', type: 'equation->description', question: 'f(x) = -2(x+3)^2 + 5. Maximum value of f(x)?', graph: { type: 'parabola', a: -2, h: -3, k: 5 }, options: ['-3', '5', '-2', '3'], correct: 1, explanation: 'a=-2<0 opens down -> has maximum. k=5 is the maximum y-value at the vertex.' },
  { id: 98, domain: 'D1', difficulty: 'Medium', type: 'equation->description', question: 'Lines y=3x+2 and y=3x-5. They are:', options: ['Perpendicular', 'Parallel', 'Identical', 'Intersecting at origin'], correct: 1, explanation: 'Same slope (m=3), different y-intercepts -> parallel, never intersect.' },
  { id: 99, domain: 'D1', difficulty: 'Hard', type: 'features->equation', question: 'System: y=2x+1 and y=-x+7. X-coordinate of intersection?', graph: { type: 'system', slope1: 2, intercept1: 1, slope2: -1, intercept2: 7 }, options: ['2', '3', '5', '4'], correct: 0, explanation: '2x+1=-x+7, 3x=6, x=2. Then y=5. Point: (2,5).' },
  { id: 100, domain: 'D2', difficulty: 'Hard', type: 'equation->description', question: 'y = |2x - 4|. Vertex of this absolute value graph?', graph: { type: 'absolute', h: 2, k: 0 }, options: ['(4, 0)', '(-2, 0)', '(2, 0)', '(0, 4)'], correct: 2, explanation: 'Set 2x-4=0: x=2. When x=2, y=0. Vertex at (2, 0).' },

  { id: 98, domain: 'D2', difficulty: 'Hard', type: 'equation->description', question: 'y = 1/x. Which best describes this graph?', graph: { type: 'rational', a: 1 }, options: ['Straight line through origin', 'U-shaped parabola', 'Curve with asymptotes at x=0 and y=0', 'Horizontal line'], correct: 2, explanation: 'y=1/x is a hyperbola with vertical asymptote x=0 and horizontal asymptote y=0. Never touches either axis.' },
  { id: 99, domain: 'D1', difficulty: 'Medium', type: 'features->equation', question: 'Line through (-2, 0) and (0, 4). Which equation?', graph: { type: 'line', slope: 2, intercept: 4 }, options: ['y = 2x - 4', 'y = 2x + 4', 'y = 4x + 2', 'y = -2x + 4'], correct: 1, explanation: 'Slope = (4-0)/(0-(-2)) = 4/2 = 2. Y-intercept = 4. y = 2x + 4.' },
  { id: 100, domain: 'D1', difficulty: 'Hard', type: 'equation->description', question: 'y = 3x + 1 and y = (1/3)x - 2. These lines are:', graph: { type: 'system', slope1: 3, intercept1: 1, slope2: 0.333, intercept2: -2 }, options: ['Parallel', 'Identical', 'Perpendicular', 'Intersecting but not perpendicular'], correct: 3, explanation: 'Perpendicular requires slope product = -1. 3 x (1/3) = 1, not -1. So these lines intersect but are NOT perpendicular.' },
];
