...
const QUESTIONS = [
  ...
  { id: 1, domain: 'D3', difficulty: 'Easy', type: 'equation→description', question: 'Which equation matches a line with slope 2 passing through the origin?', graph: { type: 'line', slope: 2, intercept: 0 }, options: ['y = 2x', 'y = x + 2', 'y = 2x + 2'], correct: 0, explanation: 'Slope-intercept form y = mx + b. Slope = 2 and y-intercept = 0 gives y = 2x. Option B has slope 1. Option C has a y-intercept of 2.' },
  { id: 2, domain: 'D1', difficulty: 'Easy', type: 'features→equation', question: 'Which equation has a y-intercept of 3 and slope of -2?', graph: { type: 'line', slope: -2, intercept: 3 }, options: ['y = -2x + 3', 'y = 2x + 3', 'y = -2x - 3'], correct: 0, explanation: 'y = mx + b with m = -2 and b = 3 gives y = -2x + 3. Option B has wrong sign for slope. Option C has wrong sign for intercept.' },
  { id: 3, domain: 'D1', difficulty: 'Easy', type: 'description→equation', question: 'A line crosses the y-axis at 4 and has slope 1. Which equation is correct?', graph: { type: 'line', slope: 1, intercept: 4 }, options: ['y = x + 4', 'y = 4x + 1', 'y = x - 4'], correct: 0, explanation: 'y = mx + b: slope = 1, y-intercept = 4 → y = x + 4. Option B swaps slope and intercept. Option C has wrong sign on intercept.' },
  { id: 4, domain: 'D1', difficulty: 'Easy', type: 'features→equation', question: 'Which line has a positive slope and negative y-intercept?', graph: { type: 'line', slope: 3, intercept: -2 }, options: ['y = 3x - 2', 'y = -3x + 2', 'y = 3x + 2'], correct: 0, explanation: 'Positive slope means line goes up left to right. Negative y-intercept means it crosses below origin. y = 3x - 2 fits both.' },
  { id: 5, domain: 'D3', difficulty: 'Easy', type: 'data→graph', question: 'A scatter plot shows points going up from left to right. What kind of correlation is this?', graph: { type: 'scatter', correlation: 'positive' }, options: ['Positive correlation', 'Negative correlation', 'No correlation'], correct: 0, explanation: 'Points rising left to right = positive correlation. Falling left to right = negative. Random scatter = no correlation.' },
  { id: 6, domain: 'D3', difficulty: 'Easy', type: 'data→graph', question: 'A bar chart shows: Math=80, Science=65, English=90. Which subject scored highest?', graph: { type: 'bar', values: [80, 65, 90], labels: ['Math', 'Sci', 'Eng'] }, options: ['English (90)', 'Math (80)', 'Science (65)'], correct: 0, explanation: 'English bar reaches 90, which is higher than Math (80) and Science (65).' },
  { id: 7, domain: 'D3', difficulty: 'Easy', type: 'data→stat', question: 'A pie chart shows 25% red, 50% blue, 25% green. What fraction is blue?', graph: { type: 'pie', values: [25, 50, 25], labels: ['Red', 'Blue', 'Green'] }, options: ['1/2', '1/4', '3/4'], correct: 0, explanation: '50% = 50/100 = 1/2. Red and green are each 25% = 1/4.' },
  { id: 8, domain: 'D3', difficulty: 'Easy', type: 'data→stat', question: 'Which scatter plot description shows NO correlation between variables?', graph: { type: 'scatter', correlation: 'none' }, options: ['Random points with no pattern', 'Points forming a line going up', 'Points forming a line going down'], correct: 0, explanation: 'No correlation = random scatter with no trend. A line going up = positive. A line going down = negative correlation.' },
  { id: 9, domain: 'D1', difficulty: 'Easy', type: 'graph→equation', question: 'A line has x-intercept 3 and y-intercept 6. What is its slope?', graph: { type: 'line', slope: -2, intercept: 6 }, options: ['m = -2', 'm = 2', 'm = 1/2'], correct: 0, explanation: 'Slope = rise/run = (0-6)/(3-0) = -6/3 = -2. The line falls from left to right.' },
  { id: 10, domain: 'D3', difficulty: 'Easy', type: 'data→stat', question: 'Data values: 2, 4, 6, 8, 10. What is the mean?', graph: { type: 'bar', values: [2, 4, 6, 8, 10], labels: ['A', 'B', 'C', 'D', 'E'] }, options: ['6', '5', '8'], correct: 0, explanation: 'Mean = sum/count = (2+4+6+8+10)/5 = 30/5 = 6.' },

  // ── MEDIUM ────────────────────────────────────────────────────────────────
  { id: 11, domain: 'D2', difficulty: 'Medium', type: 'equation→graph', question: 'y = x² - 4. Which best describes this parabola?', graph: { type: 'parabola', a: 1, h: 0, k: -4 }, options: ['Opens up, crosses x-axis at ±2', 'Opens down, vertex at (0,-4)', 'Opens up, vertex at (0,4)'], correct: 0, explanation: 'y = x² - 4 opens upward (positive coefficient). Vertex at (0,-4). Roots: x² = 4, x = ±2.' },
  { id: 12, domain: 'D2', difficulty: 'Medium', type: 'equation→graph', question: 'y = -x² + 9. Which best describes this graph?', graph: { type: 'parabola', a: -1, h: 0, k: 9 }, options: ['Opens down, vertex at (0,9)', 'Opens up, vertex at (0,9)', 'Opens down, vertex at (9,0)'], correct: 0, explanation: 'Negative leading coefficient → opens downward. Vertex at (0,9). Roots at x = ±3.' },
  { id: 13, domain: 'D2', difficulty: 'Medium', type: 'equation→graph', question: 'y = (x-2)² + 3. Where is the vertex?', graph: { type: 'parabola', a: 1, h: 2, k: 3 }, options: ['(2, 3)', '(-2, 3)', '(2, -3)'], correct: 0, explanation: 'Vertex form y = a(x-h)² + k has vertex at (h, k). Here h = 2, k = 3, so vertex is (2, 3).' },
  { id: 14, domain: 'D2', difficulty: 'Medium', type: 'data→graph', question: 'Data shows 200% increase each year starting at 100. Which graph type fits best?', graph: { type: 'exponential', base: 2, initial: 100 }, options: ['Exponential growth curve', 'Straight increasing line', 'Decreasing curve'], correct: 0, explanation: 'Percentage increase each period = exponential growth. A constant amount increase would be linear.' },
  { id: 15, domain: 'D2', difficulty: 'Medium', type: 'equation→graph', question: 'y = 3(0.5)ˣ. What kind of graph is this?', graph: { type: 'exponential', base: 0.5, initial: 3 }, options: ['Exponential decay starting at y=3', 'Exponential growth starting at y=3', 'Linear decrease from y=3'], correct: 0, explanation: 'Base 0.5 < 1 means exponential decay. When x=0, y=3(1)=3 so y-intercept is 3.' },
  { id: 16, domain: 'D3', difficulty: 'Medium', type: 'boxplot→stat', question: 'Box plot: Min=10, Q1=25, Median=40, Q3=60, Max=80. What is the IQR?', graph: { type: 'boxplot', min: 10, q1: 25, median: 40, q3: 60, max: 80 }, options: ['35', '70', '40'], correct: 0, explanation: 'IQR = Q3 - Q1 = 60 - 25 = 35. The IQR measures the middle 50% spread.' },
  { id: 17, domain: 'D3', difficulty: 'Medium', type: 'boxplot→stat', question: 'Box plot: Q1=20, Q3=50. What is the interquartile range?', graph: { type: 'boxplot', min: 5, q1: 20, median: 35, q3: 50, max: 70 }, options: ['30', '25', '50'], correct: 0, explanation: 'IQR = Q3 - Q1 = 50 - 20 = 30.' },
  { id: 18, domain: 'D3', difficulty: 'Medium', type: 'data→stat', question: 'A histogram shows most data between 60-70 with few values below 40 or above 90. What shape is this?', graph: { type: 'histogram', shape: 'normal' }, options: ['Bell curve (normal distribution)', 'Right-skewed', 'Left-skewed'], correct: 0, explanation: 'Symmetric distribution concentrated in middle with few extremes = bell curve / normal distribution.' },
  { id: 19, domain: 'D3', difficulty: 'Medium', type: 'scatter→stat', question: 'Scatter plot shows r = -0.85. What does this indicate?', graph: { type: 'scatter', correlation: 'strong negative' }, options: ['Strong negative correlation', 'Strong positive correlation', 'Weak negative correlation'], correct: 0, explanation: 'r = -0.85 is close to -1, indicating strong negative correlation. Negative = as x increases, y decreases.' },
  { id: 20, domain: 'D1', difficulty: 'Medium', type: 'features→equation', question: 'Two lines are parallel. Line 1 is y = 3x + 1. Which could be Line 2?', graph: { type: 'line', slope: 3, intercept: 5 }, options: ['y = 3x + 5', 'y = -3x + 1', 'y = (1/3)x + 1'], correct: 0, explanation: 'Parallel lines have equal slopes. Line 2 must also have slope 3. Option B has opposite slope. Option C has reciprocal slope.' },
  { id: 21, domain: 'D3', difficulty: 'Medium', type: 'data→stat', question: 'Bar chart shows sales: Jan=100, Feb=150, Mar=120. What is the mean monthly sales?', graph: { type: 'bar', values: [100, 150, 120], labels: ['Jan', 'Feb', 'Mar'] }, options: ['123.3', '150', '100'], correct: 0, explanation: 'Mean = (100+150+120)/3 = 370/3 ≈ 123.3' },
  { id: 22, domain: 'D3', difficulty: 'Medium', type: 'data→stat', question: 'Data set: 5, 8, 12, 15, 20. What is the median?', graph: { type: 'bar', values: [5, 8, 12, 15, 20], labels: ['1', '2', '3', '4', '5'] }, options: ['12', '8', '15'], correct: 0, explanation: 'Median = middle value when sorted. 5 values, middle is 3rd = 12.' },
  { id: 23, domain: 'D2', difficulty: 'Medium', type: 'equation→graph', question: 'y = 2ˣ. When x=3, what is y?', graph: { type: 'exponential', base: 2, initial: 1 }, options: ['8', '6', '9'], correct: 0, explanation: 'y = 2³ = 8. Exponential: base raised to the power of x.' },
  { id: 24, domain: 'D3', difficulty: 'Medium', type: 'data→stat', question: 'Pie chart: Category A = 40%, B = 35%, C = 25%. Total sales = $200. How much is Category A?', graph: { type: 'pie', values: [40, 35, 25], labels: ['A', 'B', 'C'] }, options: ['$80', '$70', '$40'], correct: 0, explanation: '40% of $200 = 0.40 × 200 = $80.' },
  { id: 25, domain: 'D3', difficulty: 'Medium', type: 'data→stat', question: 'A bar chart shows a 25% increase from Year 1 (80) to Year 2. What is Year 2?', graph: { type: 'bar', values: [80, 100], labels: ['Y1', 'Y2'] }, options: ['100', '105', '90'], correct: 0, explanation: '25% increase: 80 × 1.25 = 100.' },

  // ── HARD: Complex analysis ────────────────────────────────────────────────
  { id: 26, domain: 'D3', difficulty: 'Hard', type: 'boxplot→stat', question: 'Box plot: Min=5, Q1=15, Median=30, Q3=55, Max=95. Are there outliers above Q3?', graph: { type: 'boxplot', min: 5, q1: 15, median: 30, q3: 55, max: 95 }, options: ['Yes — upper fence = Q3+1.5×IQR = 115, max=95 ≤ 115', 'No — max=95 is below Q3', 'Yes — any value above Q3 is an outlier'], correct: 0, explanation: 'Upper fence = Q3 + 1.5×IQR = 55 + 1.5×40 = 55 + 60 = 115. Max=95 < 115, so no outliers.' },
  { id: 27, domain: 'D2', difficulty: 'Hard', type: 'equation→graph', question: 'y = -(x+1)² + 4. What are the x-intercepts?', graph: { type: 'parabola', a: -1, h: -1, k: 4 }, options: ['x = 1 and x = -3', 'x = -1 and x = 4', 'x = 2 and x = -4'], correct: 0, explanation: 'Set y=0: -(x+1)²+4=0, (x+1)²=4, x+1=±2, x=1 or x=-3.' },
  { id: 28, domain: 'D3', difficulty: 'Hard', type: 'data→stat', question: 'Scatter shows strong positive correlation. r ≈ 0.92. Which statement is correct?', graph: { type: 'scatter', correlation: 'strong positive' }, options: ['As x increases, y increases strongly', 'Correlation means x causes y', 'r=0.92 means 92% of points are correct'], correct: 0, explanation: 'r=0.92 means strong positive relationship. But correlation ≠ causation. r² = 0.85 means 85% of variance explained.' },
  { id: 29, domain: 'D2', difficulty: 'Hard', type: 'equation→graph', question: 'f(x) = 2x² - 8x + 6. What is the vertex?', graph: { type: 'parabola', a: 2, h: 2, k: -2 }, options: ['(2, -2)', '(-2, 2)', '(4, 6)'], correct: 0, explanation: 'Vertex x = -b/2a = 8/4 = 2. y = 2(4) - 16 + 6 = 8 - 16 + 6 = -2. Vertex = (2, -2).' },
  { id: 30, domain: 'D1', difficulty: 'Hard', type: 'features→equation', question: 'Two lines are perpendicular. Line 1 is y = (2/3)x + 1. Which is Line 2?', graph: { type: 'line', slope: -1.5, intercept: 2 }, options: ['y = -(3/2)x + 2', 'y = (2/3)x + 2', 'y = (3/2)x - 1'], correct: 0, explanation: 'Perpendicular slope = negative reciprocal of 2/3 = -3/2. So Line 2: y = -(3/2)x + 2.' },
  ...
  { id: 32, domain: 'D3', difficulty: 'Hard', type: 'boxplot→stat', question: 'Two box plots: A has IQR=10, B has IQR=40. Which is more spread out?', graph: { type: 'boxplot', min: 10, q1: 30, median: 50, q3: 70, max: 90 }, options: ['B (larger IQR = more spread)', 'A (smaller IQR = less variation)', 'They are equal'], correct: 0, explanation: 'IQR measures middle 50% spread. Larger IQR = more variability in the data.' },
  { id: 33, domain: 'D2', difficulty: 'Hard', type: 'equation→graph', question: 'y = 100(0.8)ˣ. After how many years does y fall below 50?', graph: { type: 'exponential', base: 0.8, initial: 100 }, options: ['After x = 3 (y ≈ 51.2)', 'After x = 2 (y = 64)', 'After x = 5 (y ≈ 32.8)'], correct: 0, explanation: 'x=3: y=100(0.8)³=100(0.512)=51.2. x=4: y=100(0.8)⁴=40.96 < 50. So it falls below 50 after x=3.' },
  { id: 34, domain: 'D3', difficulty: 'Hard', type: 'data→stat', question: 'Data: 10, 12, 14, 16, 100. Which measure is most affected by the outlier 100?', graph: { type: 'bar', values: [10, 12, 14, 16, 100], labels: ['A', 'B', 'C', 'D', 'E'] }, options: ['Mean (30.4)', 'Median (14)', 'Mode (none)'], correct: 0, explanation: 'Mean = 152/5 = 30.4, heavily pulled by outlier 100. Median = 14 (unchanged by outlier). Mean is most affected.' },
  { id: 35, domain: 'D3', difficulty: 'Hard', type: 'scatter→stat', question: 'Line of best fit: ŷ = 2.5x + 10. Predict y when x = 8.', graph: { type: 'scatter', correlation: 'positive' }, options: ['30', '25', '28'], correct: 0, explanation: 'ŷ = 2.5(8) + 10 = 20 + 10 = 30.' },
  { id: 36, domain: 'D1', difficulty: 'Hard', type: 'graph→equation', question: 'A line passes through (0,5) and (4,1). Which equation is correct?', graph: { type: 'line', slope: -1, intercept: 5 }, options: ['y = -x + 5', 'y = x + 5', 'y = -x - 5'], correct: 0, explanation: 'Slope = (1-5)/(4-0) = -4/4 = -1. Y-intercept = 5. So y = -x + 5.' },
  { id: 37, domain: 'D2', difficulty: 'Hard', type: 'equation→graph', question: 'y = x² - 6x + 9. What are the roots?', graph: { type: 'parabola', a: 1, h: 3, k: 0 }, options: ['x = 3 (double root)', 'x = 3 and x = -3', 'x = 6 and x = 0'], correct: 0, explanation: 'y = (x-3)² = 0 → x = 3. This is a perfect square so there is one repeated (double) root.' },
  { id: 38, domain: 'D3', difficulty: 'Hard', type: 'data→stat', question: 'Bar chart: Class A avg=82, Class B avg=76. Class A has 20 students, B has 30. What is the combined mean?', graph: { type: 'bar', values: [82, 76], labels: ['A', 'B'] }, options: ['78.4', '79', '77'], correct: 0, explanation: 'Weighted mean = (20×82 + 30×76)/(50) = (1640+2280)/50 = 3920/50 = 78.4' },
  { id: 39, domain: 'D3', difficulty: 'Hard', type: 'data→stat', question: 'Scatter plot r² = 0.64. What percent of variation in y is explained by x?', graph: { type: 'scatter', correlation: 'moderate positive' }, options: ['64%', '80%', '36%'], correct: 0, explanation: 'r² = coefficient of determination. r²=0.64 means 64% of variation in y is explained by the linear relationship with x.' },
  { id: 40, domain: 'D3', difficulty: 'Hard', type: 'boxplot→stat', question: 'Box plot range = 60, IQR = 20. What does this suggest about the data?', graph: { type: 'boxplot', min: 10, q1: 35, median: 45, q3: 55, max: 70 }, options: ['Wide overall spread, concentrated middle 50%', 'Evenly spread throughout', 'No outliers present'], correct: 0, explanation: 'Range=60 shows wide overall spread. IQR=20 means middle 50% is tightly packed. Suggests possible outliers at extremes.' },

  // ── MORE MEDIUM/HARD ──────────────────────────────────────────────────────
  { id: 41, domain: 'D3', difficulty: 'Medium', type: 'data→stat', question: 'Histogram shows data from 0-100 with most values between 70-90. What shape is this?', graph: { type: 'histogram', shape: 'left-skewed' }, options: ['Left-skewed', 'Right-skewed', 'Normal/symmetric'], correct: 0, explanation: 'Most data at high end with a tail to the left = left-skewed (negatively skewed).' },
  { id: 42, domain: 'D2', difficulty: 'Medium', type: 'equation→graph', question: 'y = 5(2)ˣ. What is the y-intercept?', graph: { type: 'exponential', base: 2, initial: 5 }, options: ['5', '2', '10'], correct: 0, explanation: 'When x=0: y = 5(2)⁰ = 5(1) = 5. The y-intercept equals the initial value.' },
  { id: 43, domain: 'D3', difficulty: 'Medium', type: 'data→stat', question: 'A survey finds 60% prefer Option A. 500 people surveyed. How many prefer A?', graph: { type: 'pie', values: [60, 40], labels: ['A', 'B'] }, options: ['300', '250', '350'], correct: 0, explanation: '60% of 500 = 0.60 × 500 = 300 people.' },
  { id: 44, domain: 'D1', difficulty: 'Medium', type: 'features→equation', question: 'A line is horizontal and passes through y = 4. What is its equation?', graph: { type: 'line', slope: 0, intercept: 4 }, options: ['y = 4', 'x = 4', 'y = 4x'], correct: 0, explanation: 'Horizontal lines have slope = 0 and equation y = constant. Here y = 4.' },
  { id: 45, domain: 'D1', difficulty: 'Medium', type: 'features→equation', question: 'A vertical line passes through x = -3. What is its equation?', graph: { type: 'line', slope: 999, intercept: -3 }, options: ['x = -3', 'y = -3', 'y = -3x'], correct: 0, explanation: 'Vertical lines have undefined slope and equation x = constant. Here x = -3.' },
  { id: 46, domain: 'D3', difficulty: 'Hard', type: 'data→stat', question: 'Two data sets have same mean = 50. Set A std dev = 2, Set B std dev = 15. Which is more spread?', graph: { type: 'histogram', shape: 'normal' }, options: ['Set B (higher std dev)', 'Set A (lower std dev)', 'They are equally spread'], correct: 0, explanation: 'Standard deviation measures spread. Higher std dev = more spread from mean. Set B with σ=15 is far more spread than Set A with σ=2.' },
  { id: 47, domain: 'D3', difficulty: 'Hard', type: 'scatter→stat', question: 'Line of best fit: ŷ = -3x + 90. For x=20, what is the predicted y?', graph: { type: 'scatter', correlation: 'negative' }, options: ['30', '60', '50'], correct: 0, explanation: 'ŷ = -3(20) + 90 = -60 + 90 = 30.' },
  { id: 48, domain: 'D3', difficulty: 'Hard', type: 'data→stat', question: 'Data: 4, 4, 7, 9, 10, 10, 12. What is the median?', graph: { type: 'bar', values: [4, 4, 7, 9, 10, 10, 12], labels: ['1', '2', '3', '4', '5', '6', '7'] }, options: ['9', '7', '10'], correct: 0, explanation: '7 values, median = 4th value = 9.' },
  { id: 49, domain: 'D2', difficulty: 'Hard', type: 'equation→graph', question: 'y = (x+3)(x-1). What are the zeros of this function?', graph: { type: 'parabola', a: 1, h: -1, k: -4 }, options: ['x = -3 and x = 1', 'x = 3 and x = -1', 'x = -3 and x = -1'], correct: 0, explanation: 'Set y=0: (x+3)=0 → x=-3; (x-1)=0 → x=1. Zeros at x=-3 and x=1.' },
  { id: 50, domain: 'D3', difficulty: 'Hard', type: 'boxplot→stat', question: 'Box plot shows median at 45. The mean is 60. What does this suggest?', graph: { type: 'boxplot', min: 20, q1: 35, median: 45, q3: 65, max: 120 }, options: ['Right-skewed (mean > median)', 'Left-skewed (mean < median)', 'Symmetric distribution'], correct: 0, explanation: 'When mean > median, data is right-skewed (pulled up by high outliers). Mean=60 > Median=45 confirms right skew.' },
];
